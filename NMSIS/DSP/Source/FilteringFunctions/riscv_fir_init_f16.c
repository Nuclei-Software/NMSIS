...
/**
  ...
  @par
                   ...
                   <code>pState</code> is of length <code>numTaps+blockSize-1</code> samples, where <code>blockSize</code> is the number of input samples processed by each call to <code>riscv_fir_f16()</code>.
 */

RISCV_DSP_ATTRIBUTE void riscv_fir_init_f16(
