 ...
 */
RISCV_DSP_ATTRIBUTE void riscv_q15_to_q7(
  const q15_t * pSrc,
        q7_t * pDst,
        uint32_t blockSize)
{
  ...
  {
    v_in = __riscv_vle16_v_i16m8(pIn, l);
    pIn += l;
    v_out = __riscv_vnclip_wx_i8m4(v_in, 8U, __RISCV_VXRM_RNU, l);
    __riscv_vse8_v_i8m4 (pDst, v_out, l);
    pDst += l;
  }
#else
