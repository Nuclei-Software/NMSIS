    ...
    for (jj = colCnt; jj > 0; jj--) {
      ...
      for (ii = numRowsA; ii > 0; ii -= l) {
        ...
        for (kk = 0; kk < numColsA; kk++) {
          ...
          vres0m4 = vfmacc_vf_f32m4(vres0m4, 1, vfsub_vv_f32m4(vfmul_vf_f32m4(v_inAR, *(pInB + 0), l), vfmul_vf_f32m4(v_inAI, *(pInB + 1), l), l), l);
          vres1m4 = vfmacc_vf_f32m4(vres1m4, 1, vfadd_vv_f32m4(vfmul_vf_f32m4(v_inAR, *(pInB + 1), l), vfmul_vf_f32m4(v_inAI, *(pInB + 0), l), l), l);
          pInB += numColsB * 2;
        }
