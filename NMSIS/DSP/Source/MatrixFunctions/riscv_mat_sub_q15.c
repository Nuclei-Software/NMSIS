 ...
 */
RISCV_DSP_ATTRIBUTE riscv_status riscv_mat_sub_q15(
        ...
        riscv_matrix_instance_q15 * pDst)
{
...

  {
    ...
    for (; (l = __riscv_vsetvl_e16m8(blkCnt)) > 0; blkCnt -= l) {
      ...
      pInB += l;
      __riscv_vse16_v_i16m8(pOut, __riscv_vssub_vv_i16m8(vx, vy, l), l);
      pOut += l;
    }
...
#if __RISCV_XLEN == 64
      write_q15x4_ia(&pOut, __QSUB16(read_q15x4_ia((q15_t**)&pInA), read_q15x4_ia((q15_t **)&pInB)));
#else
#ifdef NUCLEI_DSP_N1
      write_q15x4_ia(&pOut, __DKSUB16(read_q15x4_ia((q15_t**)&pInA), read_q15x4_ia((q15_t **)&pInB)));
#else
