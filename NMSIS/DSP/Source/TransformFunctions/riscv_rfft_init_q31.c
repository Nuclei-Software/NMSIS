...
{                                                                 \
    ...
    S->twidCoefRModifier = TWIDMOD;                               \
                                                                  \
    S->pCfft = &riscv_cfft_sR_q31_len##CFFTLEN;                     \
                                                                  \
    ...
    uint32_t bitReverseFlag)
{
    ...
    {
    case 8192U:
        status = riscv_rfft_init_8192_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 4096U:
        status = riscv_rfft_init_4096_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 2048U:
        status = riscv_rfft_init_2048_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 1024U:
        status = riscv_rfft_init_1024_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 512U:
        status = riscv_rfft_init_512_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 256U:
        status = riscv_rfft_init_256_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 128U:
        status = riscv_rfft_init_128_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 64U:
        status = riscv_rfft_init_64_q31( S,ifftFlagR,bitReverseFlag );
        break;
    case 32U:
        status = riscv_rfft_init_32_q31( S,ifftFlagR,bitReverseFlag );
        break;
    default:
