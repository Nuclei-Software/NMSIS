...
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix8_f32.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_f32.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_init_f32.c)

if (NOT DISABLEFLOAT16)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix2_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix4_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_init_f16.c)
endif()

if (NOT DISABLEFLOAT16)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix4_init_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix4_f16.c)
endif()

target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_f64.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_init_f64.c)

target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix2_q15.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix4_q15.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_q15.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_init_q15.c)

target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix2_q31.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix4_q31.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_q31.c)
...
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_rfft_fast_f32.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_rfft_fast_init_f32.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_f32.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_init_f32.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_radix8_f32.c)

target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_rfft_fast_f64.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_rfft_fast_init_f64.c)

if (NOT DISABLEFLOAT16)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_rfft_fast_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_rfft_fast_init_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_f16.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_cfft_init_f16.c)
...
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_mfcc_init_q31.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_mfcc_q31.c)

target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_mfcc_init_q15.c)
target_sources(NMSISDSP PRIVATE TransformFunctions/riscv_mfcc_q15.c)
