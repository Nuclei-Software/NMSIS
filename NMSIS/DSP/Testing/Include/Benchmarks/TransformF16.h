...
class TransformF16:public Client::Suite
    {
        ...
        private:
            ...
            riscv_cfft_instance_f16 cfftInstance;
            riscv_rfft_fast_instance_f16 rfftFastInstance;

            riscv_status status;

            riscv_cfft_radix4_instance_f16 cfftRadix4Instance;
            riscv_cfft_radix2_instance_f16 cfftRadix2Instance;
