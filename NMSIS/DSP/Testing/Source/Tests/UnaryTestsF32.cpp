...
void UnaryTestsF32::test_mat_vec_mult_f32()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          riscv_mat_vec_mult_f32(&this->in1, bp, outp);
    ...
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_add_f32(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF32::test_mat_sub_f32()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_sub_f32(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF32::test_mat_scale_f32()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_scale_f32(&this->in1,0.5f,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF32::test_mat_trans_f32()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_trans_f32(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF32::test_mat_cmplx_trans_f32()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_cmplx_trans_f32(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF32::test_mat_inverse_f32()
    {     
      ...
      for(i=0;i < nbMatrixes-1 ; i ++)
      {
          ...
          status=riscv_mat_inverse_f32(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF32::test_mat_cholesky_dpo_f32()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_cholesky_f32(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF32::test_solve_upper_triangular_f32()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_solve_upper_triangular_f32(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF32::test_solve_lower_triangular_f32()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_solve_lower_triangular_f32(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
