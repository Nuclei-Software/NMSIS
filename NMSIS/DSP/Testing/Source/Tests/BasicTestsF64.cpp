...
float64_t *outp=output.ptr();
    ...
    void BasicTestsF64::test_add_f64()
    {
        ...
        riscv_add_f64(inp1,inp2,outp,input1.nbSamples());
...
/*
    void BasicTestsF64::test_clip_f64()
    {
        ...
        riscv_clip_f64(inp,outp,this->min, this->max,input1.nbSamples());
...
*/
    ...
    void BasicTestsF64::test_mult_f64()
    {
        ...
        riscv_mult_f64(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsF64::test_negate_f64()
    {
        ...
        riscv_negate_f64(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsF64::test_offset_f64()
    {
        ...
        riscv_offset_f64(inp1,0.5,outp,input1.nbSamples());
    ...
    void BasicTestsF64::test_scale_f64()
    {
        ...
        riscv_scale_f64(inp1,0.5,outp,input1.nbSamples());
    ...
    void BasicTestsF64::test_dot_prod_f64()
    {
        ...
        riscv_dot_prod_f64(inp1,inp2,input1.nbSamples(),&r);
    ...
    void BasicTestsF64::test_abs_f64()
    {
        ...
        riscv_abs_f64(inp1,outp,input1.nbSamples());
