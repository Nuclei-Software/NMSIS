...
void UnaryTestsF16::test_mat_qr_f16()
{
   ...
   for(int i=0; i < nbMatrixes ; i++)
   {
      ...
      riscv_status status=riscv_mat_qr_f16(&in1,DEFAULT_HOUSEHOLDER_THRESHOLD_F16,&outR,&outQ,outTaup,pTmpA,pTmpB);
...
void UnaryTestsF16::test_mat_vec_mult_f16()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          riscv_mat_vec_mult_f16(&this->in1, bp, outp);
    ...
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_add_f16(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF16::test_mat_sub_f16()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_sub_f16(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF16::test_mat_scale_f16()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_scale_f16(&this->in1,0.5f,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF16::test_mat_trans_f16()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_trans_f16(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF16::test_mat_cmplx_trans_f16()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_cmplx_trans_f16(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF16::test_mat_inverse_f16()
    {     
      ...
      for(i=0;i < nbMatrixes-1 ; i ++)
      {
          ...
          status=riscv_mat_inverse_f16(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
      ...
      status=riscv_mat_inverse_f16(&this->in1,&this->out);
      ASSERT_TRUE(status==RISCV_MATH_SINGULAR);
    ...
    void UnaryTestsF16::test_mat_cholesky_dpo_f16()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_cholesky_f16(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF16::test_solve_upper_triangular_f16()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_solve_upper_triangular_f16(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF16::test_solve_lower_triangular_f16()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_solve_lower_triangular_f16(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
