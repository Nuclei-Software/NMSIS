...
#if defined(__RISCV_ARCH_ISA_RISCV) || defined(__RISCV_ARCH_ISA_A64)
...
#if defined(RISCV_MATH_VECTOR_ZVFH) && defined(RISCV_FLOAT16_SUPPORTED)
    ...
    void TransformCF16::setUp(Testing::testID_t id,std::vector<Testing::param_t>& paramsArgs,Client::PatternMgr *mgr)
    {
       ...
       switch(id)
       {
          case TransformCF16::TEST_CFFT_F16_1:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,16);
          ...
          case TransformCF16::TEST_CFFT_F16_2:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,32);
          ...
          case TransformCF16::TEST_CFFT_F16_3:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,64);
          ...
          case TransformCF16::TEST_CFFT_F16_4:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,128);
          ...
          case TransformCF16::TEST_CFFT_F16_5:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,256);
          ...
          case TransformCF16::TEST_CFFT_F16_6:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,512);
          ...
          case TransformCF16::TEST_CFFT_F16_7:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,1024);
          ...
          case TransformCF16::TEST_CFFT_F16_8:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,2048);
          ...
          case TransformCF16::TEST_CFFT_F16_9:
            ...
            status=riscv_cfft_init_f16(&varInstCfftF16,4096);
