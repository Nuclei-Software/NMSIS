...
#define ABS_ERROR_FAST_Q15 ((q15_t)20)
    ...
    void MISCQ15::test_conv_partial_q15()
    {
        ...
        riscv_status status=riscv_conv_partial_q15(inpA, inputA.nbSamples(),
          inpB, inputB.nbSamples(),
          outp,
          this->first,
          NBPOINTS);
    ...
    void MISCQ15::test_conv_partial_fast_q15()
    {
        ...
        riscv_status status=riscv_conv_partial_fast_q15(inpA, inputA.nbSamples(),
          inpB, inputB.nbSamples(),
          outp,
          this->first,
          NBPOINTS);
    ...
    void MISCQ15::test_conv_partial_opt_q15()
    {
        ...
        riscv_status status=riscv_conv_partial_opt_q15(inpA, inputA.nbSamples(),
          inpB, inputB.nbSamples(),
          outp,
          this->first,
          NBPOINTS,
    ...
    void MISCQ15::test_conv_partial_fast_opt_q15()
    {
        ...
        riscv_status status=riscv_conv_partial_fast_opt_q15(inpA, inputA.nbSamples(),
          inpB, inputB.nbSamples(),
          outp,
          this->first,
          NBPOINTS,
