...
float16_t *outp=output.ptr();
    ...
    void BasicTestsF16::test_add_f16()
    {
        ...
        riscv_add_f16(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsF16::test_clip_f16()
    {
        ...
        riscv_clip_f16(inp,outp,this->min, this->max,input1.nbSamples());
    ...
    void BasicTestsF16::test_mult_f16()
    {
        ...
        riscv_mult_f16(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsF16::test_negate_f16()
    {
        ...
        riscv_negate_f16(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsF16::test_offset_f16()
    {
        ...
        riscv_offset_f16(inp1,0.5,outp,input1.nbSamples());
    ...
    void BasicTestsF16::test_scale_f16()
    {
        ...
        riscv_scale_f16(inp1,0.5,outp,input1.nbSamples());
    ...
    void BasicTestsF16::test_dot_prod_f16()
    {
        ...
        riscv_dot_prod_f16(inp1,inp2,input1.nbSamples(),&r);

        outp[0] = r;

        ASSERT_SNR(output,ref,(float32_t)SNR_DOTPROD_THRESHOLD);
    ...
    void BasicTestsF16::test_abs_f16()
    {
        ...
        riscv_abs_f16(inp1,outp,input1.nbSamples());
