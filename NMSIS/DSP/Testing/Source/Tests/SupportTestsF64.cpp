...
void SupportTestsF64::test_bitonic_sort_out_f64()
{
 ...
 float64_t *outp = output.ptr();
 riscv_sort_instance_f64 S;

 riscv_sort_init_f64(&S, RISCV_SORT_BITONIC, RISCV_SORT_ASCENDING);
...
void SupportTestsF64::test_bubble_sort_out_f64()
{
 ...
 riscv_sort_init_f64(&S, RISCV_SORT_BUBBLE, RISCV_SORT_ASCENDING);
...
void SupportTestsF64::test_merge_sort_out_f64()
{
 ...
 riscv_merge_sort_instance_f64 S;
