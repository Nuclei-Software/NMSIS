...
#define REL_ERROR (2.0e-4)
    ...
    void BIQUADF32::test_biquad_cascade_df1_ref()
    {
        ...
        riscv_biquad_mod_coef_f32 *coefsmodp = (riscv_biquad_mod_coef_f32*)vecCoefs.ptr();
        #endif
        ...
        */
           ...
           */
#if defined(RISCV_MATH_MVEF) && !defined(RISCV_MATH_AUTOVECTORIZE)
           riscv_biquad_cascade_df1_mve_init_f32(&this->Sdf1,3,coefsp,coefsmodp,statep);
#else
           riscv_biquad_cascade_df1_init_f32(&this->Sdf1,3,coefsp,statep);
#endif
           ...
           */
           ...
           riscv_biquad_cascade_df1_f32(&this->Sdf1,inputp,outp,blockSize);
...
//#else
           ...
           riscv_biquad_cascade_df2T_compute_coefs_f32(3,coefsp,vecCoefsPtr);

           riscv_biquad_cascade_df2T_init_f32(&this->Sdf2T,
                    3,
                    vecCoefsPtr,
                    statep);
           ...
           */
           ...
           riscv_biquad_cascade_df2T_f32(&this->Sdf2T,inputp,outp,blockSize);
           outp += blockSize;
    ...
    void BIQUADF32::test_biquad_cascade_df1_rand()
    {
        ...
        */
           ...
           */
#if defined(RISCV_MATH_MVEF) && !defined(RISCV_MATH_AUTOVECTORIZE)
           riscv_biquad_cascade_df1_mve_init_f32(&this->Sdf1,numStages,coefsp,coefsmodp,statep);
#else
           riscv_biquad_cascade_df1_init_f32(&this->Sdf1,numStages,coefsp,statep);
#endif
...
//#else
           ...
           // Those Neon coefs must be computed from original coefs
           riscv_biquad_cascade_df2T_compute_coefs_f32(numStages,coefsp,vecCoefsPtr);
    ...
    void BIQUADF32::test_biquad_cascade_stereo_df2T_rand()
    {
        ...
        */
           ...
           */
           riscv_biquad_cascade_stereo_df2T_init_f32(&this->SStereodf2T,numStages,coefsp,statep);
           ...
           */
           ...
           riscv_biquad_cascade_stereo_df2T_f32(&this->SStereodf2T,inputp,outp,blockSize);
           outp += 2*blockSize;
           inputp += 2*blockSize;
