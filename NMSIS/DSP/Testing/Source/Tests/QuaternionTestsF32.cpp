...
#define ABS_ERROR (1.0e-7)
    ...
    void QuaternionTestsF32::test_quaternion_norm_f32()
    {
        ...
        riscv_quaternion_norm_f32(inp1,outp,output.nbSamples());
    ...
    void QuaternionTestsF32::test_quaternion_inverse_f32()
    {
        ...
        riscv_quaternion_inverse_f32(inp1,outp,input1.nbSamples() >> 2);
    ...
    void QuaternionTestsF32::test_quaternion_conjugate_f32()
    {
        ...
        riscv_quaternion_conjugate_f32(inp1,outp,input1.nbSamples() >> 2);
    ...
    void QuaternionTestsF32::test_quaternion_normalize_f32()
    {
        ...
        riscv_quaternion_normalize_f32(inp1,outp,input1.nbSamples() >> 2);
    ...
    void QuaternionTestsF32::test_quaternion_prod_single_f32()
    {
        ...
        {
           riscv_quaternion_product_single_f32(inp1,inp2,outp);
           outp += 4;
           inp1 += 4;
           inp2 += 4;
        }
    ...
    void QuaternionTestsF32::test_quaternion_product_f32()
    {
        ...
        riscv_quaternion_product_f32(inp1,inp2,outp,input1.nbSamples() >> 2);
    ...
    void QuaternionTestsF32::test_quaternion2rotation_f32()
    {
        ...
        riscv_quaternion2rotation_f32(inp1,outp,input1.nbSamples() >> 2);
    ...
    void QuaternionTestsF32::test_rotation2quaternion_f32()
    {
        ...
        */
        ...
        riscv_rotation2quaternion_f32(inp1,outp,output.nbSamples() >> 2);
