...
uint16_t *outp=outputLogical.ptr();
    ...
    void BasicTestsQ15::test_add_q15()
    {
        ...
        riscv_add_q15(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_clip_q15()
    {
        ...
        riscv_clip_q15(inp,outp,this->min, this->max,input1.nbSamples());
    ...
    void BasicTestsQ15::test_sub_q15()
    {
        ...
        riscv_sub_q15(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_mult_q15()
    {
        ...
        riscv_mult_q15(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_negate_q15()
    {
        ...
        riscv_negate_q15(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_offset_q15()
    {
        ...
        riscv_offset_q15(inp1,this->scalar,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_scale_q15()
    {
        ...
        riscv_scale_q15(inp1,this->scalar,0,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_dot_prod_q15()
    {
        ...
        riscv_dot_prod_q15(inp1,inp2,input1.nbSamples(),&r);
    ...
    void BasicTestsQ15::test_abs_q15()
    {
        ...
        riscv_abs_q15(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_shift_q15()
    {
        ...
        riscv_shift_q15(inp1,1,outp,input1.nbSamples());
    ...
    void BasicTestsQ15::test_and_u16()
    {
        ...
        riscv_and_u16(inp1,inp2,outp,inputLogical1.nbSamples());
    ...
    void BasicTestsQ15::test_or_u16()
    {
        ...
        riscv_or_u16(inp1,inp2,outp,inputLogical1.nbSamples());
    ...
    void BasicTestsQ15::test_not_u16()
    {
        ...
        riscv_not_u16(inp1,outp,inputLogical1.nbSamples());
    ...
    void BasicTestsQ15::test_xor_u16()
    {
        ...
        riscv_xor_u16(inp1,inp2,outp,inputLogical1.nbSamples());
