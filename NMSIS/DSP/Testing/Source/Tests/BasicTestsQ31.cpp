...
uint32_t *outp=outputLogical.ptr();
    ...
    void BasicTestsQ31::test_clip_q31()
    {
        ...
        riscv_clip_q31(inp,outp,this->min, this->max,input1.nbSamples());
    ...
    void BasicTestsQ31::test_mult_q31()
    {
        ...
        riscv_mult_q31(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsQ31::test_negate_q31()
    {
        ...
        riscv_negate_q31(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsQ31::test_offset_q31()
    {
        ...
        riscv_offset_q31(inp1,this->scalar,outp,input1.nbSamples());
    ...
    void BasicTestsQ31::test_scale_q31()
    {
        ...
        riscv_scale_q31(inp1,this->scalar,0,outp,input1.nbSamples());
    ...
    void BasicTestsQ31::test_dot_prod_q31()
    {
        ...
        riscv_dot_prod_q31(inp1,inp2,input1.nbSamples(),&r);
    ...
    void BasicTestsQ31::test_abs_q31()
    {
        ...
        riscv_abs_q31(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsQ31::test_shift_q31()
    {
        ...
        riscv_shift_q31(inp1,1,outp,input1.nbSamples());
