...
#define REL_ERROR (1.0e-13)
#define ABS_ERROR (2.0e-13)
    ...
    void TransformCF64::setUp(Testing::testID_t id,std::vector<Testing::param_t>& paramsArgs,Client::PatternMgr *mgr)
    {
       ...
       switch(id)
       {
          case TransformCF64::TEST_CFFT_F64_1:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,16);
          ...
          case TransformCF64::TEST_CFFT_F64_2:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,32);
          ...
          case TransformCF64::TEST_CFFT_F64_3:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,64);
          ...
          case TransformCF64::TEST_CFFT_F64_4:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,128);
          ...
          case TransformCF64::TEST_CFFT_F64_5:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,256);
          ...
          case TransformCF64::TEST_CFFT_F64_6:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,512);
          ...
          case TransformCF64::TEST_CFFT_F64_7:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,1024);
          ...
          case TransformCF64::TEST_CFFT_F64_8:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,2048);
          ...
          case TransformCF64::TEST_CFFT_F64_9:
            ...
            status=riscv_cfft_init_f64(&varInstCfftF64,4096);
