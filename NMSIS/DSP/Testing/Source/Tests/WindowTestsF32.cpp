...
void WindowTestsF32::test_welch_f32()
{
        ...
        riscv_welch_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_bartlett_f32()
{
        ...
        riscv_bartlett_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hamming_f32()
{
        ...
        riscv_hamming_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hanning_f32()
{
        ...
        riscv_hanning_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall3_f32()
{
        ...
        riscv_nuttall3_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall4_f32()
{
        ...
        riscv_nuttall4_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall3a_f32()
{
        ...
        riscv_nuttall3a_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall3b_f32()
{
        ...
        riscv_nuttall3b_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall4a_f32()
{
        ...
        riscv_nuttall4a_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_blackman_harris_92db_f32()
{
        ...
        riscv_blackman_harris_92db_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall4b_f32()
{
        ...
        riscv_nuttall4b_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_nuttall4c_f32()
{
        ...
        riscv_nuttall4c_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft90d_f32()
{
        ...
        riscv_hft90d_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft95_f32()
{
        ...
        riscv_hft95_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft116d_f32()
{
        ...
        riscv_hft116d_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft144d_f32()
{
        ...
        riscv_hft144d_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft169d_f32()
{
        ...
        riscv_hft169d_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft196d_f32()
{
        ...
        riscv_hft196d_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft223d_f32()
{
        ...
        riscv_hft223d_f32(outp,output.nbSamples());
...
void WindowTestsF32::test_hft248d_f32()
{
        ...
        riscv_hft248d_f32(outp,output.nbSamples());
