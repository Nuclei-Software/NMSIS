...
#define PREPAREVECDATA2()                                             \
    ...
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          riscv_mat_vec_mult_q31(&this->in1, bp, outp);
    ...
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_add_q31(&this->in1,&this->in2,&this->out);
...
void UnaryTestsQ31::test_mat_sub_q31()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_sub_q31(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsQ31::test_mat_scale_q31()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_scale_q31(&this->in1,ONEHALF,0,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsQ31::test_mat_trans_q31()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_trans_q31(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsQ31::test_mat_cmplx_trans_q31()
    {     
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_cmplx_trans_q31(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
