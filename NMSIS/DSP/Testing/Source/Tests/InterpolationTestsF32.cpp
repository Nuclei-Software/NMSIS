...
#define REL_ERROR (8.0e-5)
    ...
    void InterpolationTestsF32::test_linear_interp_f32()
    {
       ...
       {
          outp[nb] = riscv_linear_interp_f32(&S,inp[nb]);
       }
    ...
    void InterpolationTestsF32::test_bilinear_interp_f32()
    {
       ...
       for(nb = 0; nb < input.nbSamples(); nb += 2)
       {
          x = inp[nb];
          y = inp[nb+1];
          *outp++=riscv_bilinear_interp_f32(&SBI,x,y);
       }
    ...
    void InterpolationTestsF32::test_spline_square_f32()
    {
       ...
       riscv_spline_init_f32(&S, RISCV_SPLINE_PARABOLIC_RUNOUT, inpX, inpY, 4, coef, buf);
       riscv_spline_f32(&S, outX, outp, 20);
    ...
    void InterpolationTestsF32::test_spline_sine_f32()
    {
       ...
       riscv_spline_instance_f32 S;
       riscv_spline_init_f32(&S, RISCV_SPLINE_NATURAL, inpX, inpY, 9, coef, buf);
       riscv_spline_f32(&S, outX, outp, 33);
    ...
    void InterpolationTestsF32::test_spline_ramp_f32()
    {
       ...
       riscv_spline_instance_f32 S;
       riscv_spline_init_f32(&S, RISCV_SPLINE_PARABOLIC_RUNOUT, inpX, inpY, 3, coef, buf);
       riscv_spline_f32(&S, outX, outp, 30);
