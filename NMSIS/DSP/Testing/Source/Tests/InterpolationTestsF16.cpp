...
#define ABS_ERROR (7.0e-3)
    ...
    void InterpolationTestsF16::test_linear_interp_f16()
    {
       ...
       {
          outp[nb] = riscv_linear_interp_f16(&S,inp[nb]);
       }
    ...
    void InterpolationTestsF16::test_bilinear_interp_f16()
    {
       ...
       for(nb = 0; nb < input.nbSamples(); nb += 2)
       {
          x = inp[nb];
          y = inp[nb+1];
          *outp++=riscv_bilinear_interp_f16(&SBI,x,y);
       }
    ...
    void InterpolationTestsF16::test_spline_square_f16()
    {
       ...
       riscv_spline_instance_f16 S;
       riscv_spline_init_f16(&S, RISCV_SPLINE_PARABOLIC_RUNOUT, inpX, inpY, 4, coef, buf);
       riscv_spline_f16(&S, outX, outp, 20);
    ...
    void InterpolationTestsF16::test_spline_sine_f16()
    {
       ...
       riscv_spline_instance_f16 S;
       riscv_spline_init_f16(&S, RISCV_SPLINE_NATURAL, inpX, inpY, 9, coef, buf);
       riscv_spline_f16(&S, outX, outp, 33);
    ...
    void InterpolationTestsF16::test_spline_ramp_f16()
    {
       ...
       riscv_spline_instance_f16 S;
       riscv_spline_init_f16(&S, RISCV_SPLINE_PARABOLIC_RUNOUT, inpX, inpY, 3, coef, buf);
       riscv_spline_f16(&S, outX, outp, 30);
