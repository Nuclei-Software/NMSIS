...
#define ABS_ERROR (1.0e-1)
    ...
    void BIQUADF16::test_biquad_cascade_df1_ref()
    {
        ...
        #if defined(RISCV_MATH_MVE_FLOAT16) && !defined(RISCV_MATH_AUTOVECTORIZE)
        riscv_biquad_mod_coef_f16 *coefsmodp = (riscv_biquad_mod_coef_f16*)vecCoefs.ptr();
        #endif
        ...
        */
           ...
           */
#if defined(RISCV_MATH_MVE_FLOAT16) && !defined(RISCV_MATH_AUTOVECTORIZE)
           riscv_biquad_cascade_df1_mve_init_f16(&this->Sdf1,3,coefsp,coefsmodp,statep);
#else
           riscv_biquad_cascade_df1_init_f16(&this->Sdf1,3,coefsp,statep);
#endif
    ...
    void BIQUADF16::test_biquad_cascade_df1_rand()
    {
        ...
        */
           ...
           */
#if defined(RISCV_MATH_MVE_FLOAT16) && !defined(RISCV_MATH_AUTOVECTORIZE)
           riscv_biquad_cascade_df1_mve_init_f16(&this->Sdf1,numStages,coefsp,coefsmodp,statep);
#else
           riscv_biquad_cascade_df1_init_f16(&this->Sdf1,numStages,coefsp,statep);
#endif
    ...
    void BIQUADF16::test_biquad_cascade_df2T_rand()
    {
        ...
        */
           ...
           */
           ...
           riscv_biquad_cascade_df2T_init_f16(&this->Sdf2T,numStages,coefsp,statep);
    ...
    void BIQUADF16::test_biquad_cascade_stereo_df2T_rand()
    {
        ...
        */
           ...
           */
           riscv_biquad_cascade_stereo_df2T_init_f16(&this->SStereodf2T,numStages,coefsp,statep);
