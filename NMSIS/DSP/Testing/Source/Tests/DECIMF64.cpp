...
#define REL_ERROR (8.0e-4)
    ...
    void DECIMF64::test_fir_decimate_f64()
    {
        ...
        for(nb=0;nb < nbTests; nb++)
        {
            ...
            this->status=riscv_fir_decimate_init_f64(&(this->S),
               this->numTaps,
               this->q,
               pCoefs,
               state.ptr(),
            ...
            ASSERT_TRUE(this->status == RISCV_MATH_SUCCESS);

            riscv_fir_decimate_f64(
                 &(this->S),
                 pSrc,
                 pDst,
                 this->blocksize);
    ...
    void DECIMF64::test_fir_interpolate_f64()
    {
        ...
        for(nb=0;nb < nbTests; nb++)
        {
            ...
            this->status=riscv_fir_interpolate_init_f64(&(this->SI),
               this->q,
               this->numTaps,
               pCoefs,
               state.ptr(),
