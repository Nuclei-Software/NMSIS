...
float32_t *outp=output.ptr();
    ...
    void BasicTestsF32::test_add_f32()
    {
        ...
        riscv_add_f32(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsF32::test_clip_f32()
    {
        ...
        riscv_clip_f32(inp,outp,this->min, this->max,input1.nbSamples());
    ...
    void BasicTestsF32::test_mult_f32()
    {
        ...
        riscv_mult_f32(inp1,inp2,outp,input1.nbSamples());
    ...
    void BasicTestsF32::test_negate_f32()
    {
        ...
        riscv_negate_f32(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsF32::test_offset_f32()
    {
        ...
        riscv_offset_f32(inp1,0.5,outp,input1.nbSamples());
    ...
    void BasicTestsF32::test_scale_f32()
    {
        ...
        riscv_scale_f32(inp1,0.5,outp,input1.nbSamples());
    ...
    void BasicTestsF32::test_dot_prod_f32()
    {
        ...
        riscv_dot_prod_f32(inp1,inp2,input1.nbSamples(),&r);
    ...
    void BasicTestsF32::test_abs_f32()
    {
        ...
        riscv_abs_f32(inp1,outp,input1.nbSamples());
