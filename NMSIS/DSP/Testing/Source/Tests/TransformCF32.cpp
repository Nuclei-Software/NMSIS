    ...
    void TransformCF32::setUp(Testing::testID_t id,std::vector<Testing::param_t>& paramsArgs,Client::PatternMgr *mgr)
    {
       ...
       switch(id)
       {
          case TransformCF32::TEST_CFFT_F32_1:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,16);
          ...
          case TransformCF32::TEST_CFFT_F32_2:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,32);
          ...
          case TransformCF32::TEST_CFFT_F32_3:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,64);
          ...
          case TransformCF32::TEST_CFFT_F32_4:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,128);
          ...
          case TransformCF32::TEST_CFFT_F32_5:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,256);
          ...
          case TransformCF32::TEST_CFFT_F32_6:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,512);
          ...
          case TransformCF32::TEST_CFFT_F32_7:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,1024);
          ...
          case TransformCF32::TEST_CFFT_F32_8:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,2048);
          ...
          case TransformCF32::TEST_CFFT_F32_9:
            ...
            status=riscv_cfft_init_f32(&varInstCfftF32,4096);
