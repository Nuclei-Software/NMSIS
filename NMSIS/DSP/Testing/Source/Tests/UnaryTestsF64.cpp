...
void UnaryTestsF64::test_mat_sub_f64()
{
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_sub_f64(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF64::test_mat_trans_f64()
{
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_trans_f64(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
...
void UnaryTestsF64::test_mat_inverse_f64()
    {
      ...
      for(i=0;i < nbMatrixes - 1 ; i ++)
      {
          ...
          status=riscv_mat_inverse_f64(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF64::test_mat_cholesky_dpo_f64()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_cholesky_f64(&this->in1,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF64::test_solve_upper_triangular_f64()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_solve_upper_triangular_f64(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF64::test_solve_lower_triangular_f64()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_solve_lower_triangular_f64(&this->in1,&this->in2,&this->out);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
    ...
    void UnaryTestsF64::test_mat_ldl_f64()
    {
      ...
      for(i=0;i < nbMatrixes ; i ++)
      {
          ...
          status=riscv_mat_ldlt_f64(&this->in1,&this->outll,&this->outd,(uint16_t*)outpp);
          ASSERT_TRUE(status==RISCV_MATH_SUCCESS);
