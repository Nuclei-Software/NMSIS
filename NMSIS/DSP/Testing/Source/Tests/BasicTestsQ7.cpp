...
uint8_t *outp=outputLogical.ptr();
    ...
    void BasicTestsQ7::test_clip_q7()
    {
        ...
        riscv_clip_q7(inp,outp,this->min, this->max,input1.nbSamples());
    ...
    void BasicTestsQ7::test_mult_q7()
    {
        ...
        riscv_mult_q7(inp1,inp2,outp,input1.nbSamples());
    ...
    */
    ...
    void BasicTestsQ7::test_negate_q7()
    {
        ...
        riscv_negate_q7(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsQ7::test_offset_q7()
    {
        ...
        riscv_offset_q7(inp1,this->scalar,outp,input1.nbSamples());
    ...
    void BasicTestsQ7::test_scale_q7()
    {
        ...
        riscv_scale_q7(inp1,this->scalar,0,outp,input1.nbSamples());
    ...
    void BasicTestsQ7::test_dot_prod_q7()
    {
        ...
        riscv_dot_prod_q7(inp1,inp2,input1.nbSamples(),&r);
    ...
    void BasicTestsQ7::test_abs_q7()
    {
        ...
        riscv_abs_q7(inp1,outp,input1.nbSamples());
    ...
    void BasicTestsQ7::test_shift_q7()
    {
        ...
        riscv_shift_q7(inp1,1,outp,input1.nbSamples());
