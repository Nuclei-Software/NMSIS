...
void WindowTestsF64::test_welch_f64()
{
        ...
        riscv_welch_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_bartlett_f64()
{
        ...
        riscv_bartlett_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hamming_f64()
{
        ...
        riscv_hamming_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hanning_f64()
{
        ...
        riscv_hanning_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall3_f64()
{
        ...
        riscv_nuttall3_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall4_f64()
{
        ...
        riscv_nuttall4_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall3a_f64()
{
        ...
        riscv_nuttall3a_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall3b_f64()
{
        ...
        riscv_nuttall3b_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall4a_f64()
{
        ...
        riscv_nuttall4a_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_blackman_harris_92db_f64()
{
        ...
        riscv_blackman_harris_92db_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall4b_f64()
{
        ...
        riscv_nuttall4b_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_nuttall4c_f64()
{
        ...
        riscv_nuttall4c_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft90d_f64()
{
        ...
        riscv_hft90d_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft95_f64()
{
        ...
        riscv_hft95_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft116d_f64()
{
        ...
        riscv_hft116d_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft144d_f64()
{
        ...
        riscv_hft144d_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft169d_f64()
{
        ...
        riscv_hft169d_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft196d_f64()
{
        ...
        riscv_hft196d_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft223d_f64()
{
        ...
        riscv_hft223d_f64(outp,output.nbSamples());
...
void WindowTestsF64::test_hft248d_f64()
{
        ...
        riscv_hft248d_f64(outp,output.nbSamples());
