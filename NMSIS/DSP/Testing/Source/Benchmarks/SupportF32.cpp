...
#include "Error.h"
    ...
    {
       riscv_fill_f32(0,this->pDst,this->nbSamples);
    }

    void SupportF32::test_q7_to_f32()
    {
      riscv_q7_to_float(this->pSrcQ7,this->pDst,this->nbSamples);
    }

    void SupportF32::test_q15_to_f32()
    {
      riscv_q15_to_float(this->pSrcQ15,this->pDst,this->nbSamples);
    }

    void SupportF32::test_q31_to_f32()
    {
      riscv_q31_to_float(this->pSrcQ31,this->pDst,this->nbSamples);
    }

    void SupportF32::test_weighted_average_f32()
    {
      riscv_weighted_average_f32(this->pSrc, this->pWeights,this->nbSamples);
    }
