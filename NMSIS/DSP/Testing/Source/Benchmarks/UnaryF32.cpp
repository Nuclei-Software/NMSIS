...
static int cholesky_offset(int d)
{
  ...
  return(offset);
    ...
    {
       riscv_mat_scale_f32(&this->in1,0.5,&this->out);
    }

    void UnaryF32::test_mat_inverse_f32()
    {
       riscv_mat_inverse_f32(&this->in1,&this->out);
    }

    void UnaryF32::test_mat_trans_f32()
    {
       riscv_mat_trans_f32(&this->in1,&this->out);
    }

    void UnaryF32::test_mat_cmplx_trans_f32()
    {
       riscv_mat_cmplx_trans_f32(&this->in1,&this->out);
    }

    void UnaryF32::test_mat_add_f32()
    {
       riscv_mat_add_f32(&this->in1,&this->in1,&this->out);
    }

    void UnaryF32::test_mat_sub_f32()
    {
       riscv_mat_sub_f32(&this->in1,&this->in1,&this->out);
    }

    void UnaryF32::test_mat_vec_mult_f32()
    {
       riscv_mat_vec_mult_f32(&this->in1, vecp, outp);
    }

    void UnaryF32::test_mat_cholesky_dpo_f32()
    {
        riscv_mat_cholesky_f32(&this->in1,&this->out);
    }

    void UnaryF32::test_solve_upper_triangular_f32()
    {
        riscv_mat_solve_upper_triangular_f32(&this->in1,&this->in2,&this->out);
    }

    void UnaryF32::test_solve_lower_triangular_f32()
    {
        riscv_mat_solve_lower_triangular_f32(&this->in1,&this->in2,&this->out);
    }

    void UnaryF32::test_ldlt_decomposition_f32()
    {
        riscv_mat_ldlt_f32(&this->in1,&this->outll,&this->outd,(uint16_t*)outp);
    }
