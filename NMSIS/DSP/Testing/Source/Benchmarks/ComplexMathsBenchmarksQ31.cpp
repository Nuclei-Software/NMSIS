...
#include "Error.h"
    ...
    {
       riscv_cmplx_conj_q31(this->inp1,this->outp,this->nb); 
    } 
    ...
    void ComplexMathsBenchmarksQ31::vec_dot_prod_q31()
    {
       ...
       riscv_cmplx_dot_prod_q31(this->inp1,this->inp2,this->nb,&real,&imag);
    } 

    void ComplexMathsBenchmarksQ31::vec_mag_q31()
    {
       riscv_cmplx_mag_q31(this->inp1,this->outp,this->nb);
    } 

    void ComplexMathsBenchmarksQ31::vec_mag_squared_q31()
    {
       riscv_cmplx_mag_squared_q31(this->inp1,this->outp,this->nb);
    } 

    void ComplexMathsBenchmarksQ31::vec_mult_cmplx_q31()
    {
       riscv_cmplx_mult_cmplx_q31(this->inp1,this->inp2,this->outp,this->nb);
    }

    void ComplexMathsBenchmarksQ31::vec_mult_real_q31()
    {
       riscv_cmplx_mult_real_q31(this->inp1,this->inp3,this->outp,this->nb);
    }
