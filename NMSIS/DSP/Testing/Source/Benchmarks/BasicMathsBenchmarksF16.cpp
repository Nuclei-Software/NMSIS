...
#include "Error.h"
    ...
    {     
       riscv_mult_f16(this->inp1,this->inp2,this->outp,this->nb);
    } 

    void BasicMathsBenchmarksF16::vec_add_f16()
    {
       riscv_add_f16(inp1,inp2,outp,this->nb);
    } 

    void BasicMathsBenchmarksF16::vec_sub_f16()
    {
       riscv_sub_f16(inp1,inp2,outp,this->nb);
    } 

    void BasicMathsBenchmarksF16::vec_abs_f16()
    {
       riscv_abs_f16(inp1,outp,this->nb);
    } 

    void BasicMathsBenchmarksF16::vec_negate_f16()
    {
       riscv_negate_f16(inp1,outp,this->nb);
    }

    void BasicMathsBenchmarksF16::vec_offset_f16()
    {
       riscv_offset_f16(inp1,1.0,outp,this->nb);
    }

    void BasicMathsBenchmarksF16::vec_scale_f16()
    {
       riscv_scale_f16(inp1,1.0,outp,this->nb);        
    }
    ...
    void BasicMathsBenchmarksF16::vec_dot_f16()
    {
       ...
       riscv_dot_prod_f16(inp1,inp2,this->nb,&result);   
