...
#include "Test.h"
    ...
    {
      (void)riscv_entropy_f32(inap,this->nb);
    ...
    void StatsF32::test_logsumexp_f32()
    {
       ...
       (void)riscv_logsumexp_f32(inap,this->nb);
    ...
    void StatsF32::test_kullback_leibler_f32()
    {
      ...
      (void)riscv_kullback_leibler_f32(inap,inbp,this->nb);
    ...
    void StatsF32::test_logsumexp_dot_prod_f32()
    {
      ...
      (void)riscv_logsumexp_dot_prod_f32(inap,inbp,this->nb,tmpp);
