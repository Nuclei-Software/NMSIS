...
#include "Error.h"
    ...
    {
       riscv_mat_scale_q15(&this->in1,0x4000,1,&this->out);
    }

    void UnaryQ15::test_mat_trans_q15()
    {
       riscv_mat_trans_q15(&this->in1,&this->out);
    }

    void UnaryQ15::test_mat_cmplx_trans_q15()
    {
       riscv_mat_cmplx_trans_q15(&this->in1,&this->out);
    }

    void UnaryQ15::test_mat_add_q15()
    {
       riscv_mat_add_q15(&this->in1,&this->in1,&this->out);
    }

    void UnaryQ15::test_mat_sub_q15()
    {
       riscv_mat_sub_q15(&this->in1,&this->in1,&this->out);
    }

    void UnaryQ15::test_mat_vec_mult_q15()
    {
       riscv_mat_vec_mult_q15(&this->in1, vecp, outp);
    }
