...
#include "Error.h"
    ...
    {
      riscv_mat_mult_q31(&this->in1,&this->in2,&this->out);
    }

    void BinaryQ31::test_mat_cmplx_mult_q31()
    {
      riscv_mat_cmplx_mult_q31(&this->in1,&this->in2,&this->out);
    }

    void BinaryQ31::test_mat_mult_fast_q31()
    {
      riscv_mat_mult_fast_q31(&this->in1,&this->in2,&this->out);
    }

    void BinaryQ31::test_mat_mult_opt_q31()
    {
      riscv_mat_mult_opt_q31(&this->in1,&this->in2,&this->out,this->tmpPtr);
    }
