...
static __ALIGNED(8) q31_t coeffArray[64];
    ...
    void FIRQ31::setUp(Testing::testID_t id,std::vector<Testing::param_t>& params,Client::PatternMgr *mgr)
    {
       ...
       state.create(2*RISCV_ROUND_UP(this->nbSamples,4) + this->nbSamples + this->nbTaps - 1,FIRQ31::STATE_Q31_ID,mgr);
       ...
       switch(id)
       {
           case TEST_FIR_Q31_1:
              ...
              */
              ...
              riscv_fir_init_q31(&instFir,this->nbTaps,coefs.ptr(),state.ptr(),this->nbSamples);
           ...
           case TEST_LMS_Q31_2:
              ...
              riscv_lms_init_q31(&instLms,this->nbTaps,coefs.ptr(),state.ptr(),100,this->nbSamples,1);
           ...
           case TEST_LMS_NORM_Q31_3:
              ...
              error.create(this->nbSamples,FIRQ31::ERR_Q31_ID,mgr);
              // Value of mu and postShift are arbitrary just for benchmark
              riscv_lms_norm_init_q31(&instLmsNorm,this->nbTaps,coefs.ptr(),state.ptr(),100,this->nbSamples,1);
