...
#include "Test.h"
    ...
    {
      (void)riscv_entropy_f16(inap,this->nb);
    ...
    void StatsF16::test_logsumexp_f16()
    {
       ...
       (void)riscv_logsumexp_f16(inap,this->nb);
    ...
    void StatsF16::test_kullback_leibler_f16()
    {
      ...
      (void)riscv_kullback_leibler_f16(inap,inbp,this->nb);
    ...
    void StatsF16::test_logsumexp_dot_prod_f16()
    {
      ...
      (void)riscv_logsumexp_dot_prod_f16(inap,inbp,this->nb,tmpp);
