...
#include "Error.h"
    ...
    {
       riscv_fill_q31(0xaf, this->pDst, this->nbSamples);
    }

    void SupportQ31::test_q7_to_q31()
    {
       riscv_q7_to_q31(this->pSrcQ7, this->pDst, this->nbSamples);
    }

    void SupportQ31::test_q15_to_q31()
    {
       riscv_q15_to_q31(this->pSrcQ15, this->pDst, this->nbSamples);
    }
