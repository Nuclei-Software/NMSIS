...
#include "Error.h"
    ...
    {     
       riscv_mat_scale_q7(&this->in1,0x4000,1,&this->out);
    } 
*/
    void UnaryQ7::test_mat_trans_q7()
    {     
       riscv_mat_trans_q7(&this->in1,&this->out);
    } 
/*
    void UnaryQ7::test_mat_add_q7()
    {     
       riscv_mat_add_q7(&this->in1,&this->in1,&this->out);
    } 

    void UnaryQ7::test_mat_sub_q7()
    {     
       riscv_mat_sub_q7(&this->in1,&this->in1,&this->out);
    } 
    */

    void UnaryQ7::test_mat_vec_mult_q7()
    {     
       riscv_mat_vec_mult_q7(&this->in1, vecp, outp);
    }
