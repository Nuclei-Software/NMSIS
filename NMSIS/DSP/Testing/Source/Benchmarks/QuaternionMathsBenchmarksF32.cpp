...
#include "Error.h"
    ...
    void QuaternionMathsBenchmarksF32::test_quaternion_product_f32()
    {
        ...
        riscv_quaternion_product_f32(this->inp1,this->inp2,outp,this->nb);
    ...
    {
        riscv_quaternion2rotation_f32(this->inp1,this->outp,this->nb);
    ...
    void QuaternionMathsBenchmarksF32::test_rotation2quaternion_f32()
    {
        ...
        riscv_rotation2quaternion_f32(this->inp1,this->outp,this->nb);
