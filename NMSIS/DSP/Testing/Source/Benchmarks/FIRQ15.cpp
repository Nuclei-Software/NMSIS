    ...
    void FIRQ15::setUp(Testing::testID_t id,std::vector<Testing::param_t>& params,Client::PatternMgr *mgr)
    {
       ...
       switch(id)
       {
...
#endif
              riscv_fir_init_q15(&instFir,this->nbTaps,coefs.ptr(),state.ptr(),this->nbSamples);
           ...
           case TEST_LMS_Q15_2:
              ...
              riscv_lms_init_q15(&instLms,this->nbTaps,coefs.ptr(),state.ptr(),100,this->nbSamples,1);
           ...
           case TEST_LMS_NORM_Q15_3:
              refs.reload(FIRQ15::REFS1_Q15_ID,mgr,this->nbSamples);
              error.create(this->nbSamples,FIRQ15::ERR_Q15_ID,mgr);
              riscv_lms_norm_init_q15(&instLmsNorm,this->nbTaps,coefs.ptr(),state.ptr(),100,this->nbSamples,1);
