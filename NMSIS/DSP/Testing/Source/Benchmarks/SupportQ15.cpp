...
#include "Error.h"
    ...
    {
      riscv_copy_q15(this->pSrc, this->pDst, this->nbSamples);
    }

    void SupportQ15::test_fill_q15()
    {
       riscv_fill_q15(0x9f, this->pDst, this->nbSamples);
    }

    void SupportQ15::test_q7_to_q15()
    {
       riscv_q7_to_q15(this->pSrcQ7, this->pDst, this->nbSamples);
    }

    void SupportQ15::test_q31_to_q15()
    {
       riscv_q31_to_q15(this->pSrcQ31, this->pDst, this->nbSamples);
    }
