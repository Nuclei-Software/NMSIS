...
#include "Error.h"
    ...
    {
       riscv_mat_scale_q31(&this->in1,0x40000000,1,&this->out);
    }

    void UnaryQ31::test_mat_trans_q31()
    {
       riscv_mat_trans_q31(&this->in1,&this->out);
    }

    void UnaryQ31::test_mat_cmplx_trans_q31()
    {
       riscv_mat_cmplx_trans_q31(&this->in1,&this->out);
    }

    void UnaryQ31::test_mat_add_q31()
    {
       riscv_mat_add_q31(&this->in1,&this->in1,&this->out);
    }

    void UnaryQ31::test_mat_sub_q31()
    {
       riscv_mat_sub_q31(&this->in1,&this->in1,&this->out);
    }

    void UnaryQ31::test_mat_vec_mult_q31()
    {
       riscv_mat_vec_mult_q31(&this->in1, vecp, outp);
    }
