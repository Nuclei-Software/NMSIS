...
#include "Error.h"
    ...
    {
       riscv_mult_q7(this->inp1,this->inp2,this->outp,this->nb);
    } 

    void BasicMathsBenchmarksQ7::vec_add_q7()
    {
       riscv_add_q7(this->inp1,this->inp2,this->outp,this->nb);
    } 

    void BasicMathsBenchmarksQ7::vec_sub_q7()
    {
       riscv_sub_q7(this->inp1,this->inp2,this->outp,this->nb);
    } 

    void BasicMathsBenchmarksQ7::vec_abs_q7()
    {
       riscv_abs_q7(this->inp1,this->outp,this->nb);
    } 

    void BasicMathsBenchmarksQ7::vec_negate_q7()
    {
       riscv_negate_q7(this->inp1,this->outp,this->nb);
    }

    void BasicMathsBenchmarksQ7::vec_offset_q7()
    {
       riscv_offset_q7(this->inp1,1.0,this->outp,this->nb);
    }

   void BasicMathsBenchmarksQ7::vec_scale_q7()
    {
       riscv_scale_q7(this->inp1,0x45,1,this->outp,this->nb);
    }
    ...
    void BasicMathsBenchmarksQ7::vec_dot_q7()
    {
       ...
       riscv_dot_prod_q7(this->inp1,this->inp2,this->nb,&result);
