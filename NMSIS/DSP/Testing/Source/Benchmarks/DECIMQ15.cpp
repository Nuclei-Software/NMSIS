...
#include "Error.h"
    ...
    {
       riscv_fir_decimate_q15(&instDecim,this->pSrc,this->pDst,this->nbSamples);
    } 
    ...
    {
       riscv_fir_interpolate_q15(&instInterpol,this->pSrc,this->pDst,this->nbSamples);
    } 
    ...
    void DECIMQ15::setUp(Testing::testID_t id,std::vector<Testing::param_t>& params,Client::PatternMgr *mgr)
    {
       ...
       switch(id)
       {
           case TEST_FIR_DECIMATE_Q15_1:
              ...
              riscv_fir_decimate_init_q15(&instDecim,
                 this->nbTaps,
           ...
           case TEST_FIR_INTERPOLATE_Q15_2:
              ...
              riscv_fir_interpolate_init_q15(&instInterpol,
