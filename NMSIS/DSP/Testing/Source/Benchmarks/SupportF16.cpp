...
#include "Error.h"
    ...
    {
       riscv_fill_f16(0,this->pDst,this->nbSamples);
    }

    void SupportF16::test_q15_to_f16()
    {
      riscv_q15_to_f16(this->pSrcQ15,this->pDst,this->nbSamples);
    }


    void SupportF16::test_f32_to_f16()
    {
      riscv_float_to_f16(this->pSrcF32,this->pDst,this->nbSamples);
    }

    void SupportF16::test_weighted_average_f16()
    {
      riscv_weighted_average_f16(this->pSrc, this->pWeights,this->nbSamples);
    }
