...
#include "Error.h"
    ...
    { 
       riscv_cfft_q31(&this->cfftInstance, this->pDst, this->ifft,this->bitRev);
    } 

    void TransformQ31::test_rfft_q31()
    { 
       riscv_rfft_q31(&this->rfftInstance, this->pSrc, this->pDst);
    } 
    ...
    { 
       riscv_cfft_radix4_q31(&this->cfftRadix4Instance,this->pDst);
    } 

    void TransformQ31::test_cfft_radix2_q31()
    { 
       riscv_cfft_radix2_q31(&this->cfftRadix2Instance,this->pDst);
    } 
    ...
    void TransformQ31::setUp(Testing::testID_t id,std::vector<Testing::param_t>& params,Client::PatternMgr *mgr)
    {
       ...
       switch(id)
       {
          case TEST_CFFT_Q31_1:
            ...
            riscv_cfft_init_q31(&this->cfftInstance,this->nbSamples);
          ...
          case TEST_RFFT_Q31_2:
            ...
            riscv_rfft_init_q31(&this->rfftInstance, this->nbSamples,this->ifft,this->bitRev);
          break;
          ...
          case TEST_CFFT_RADIX4_Q31_4:
            ...
            riscv_cfft_radix4_init_q31(&this->cfftRadix4Instance,
                this->nbSamples,
                this->ifft,
                this->bitRev);
          ...
          case TEST_CFFT_RADIX2_Q31_5:
            ...
            riscv_cfft_radix2_init_q31(&this->cfftRadix2Instance,
                this->nbSamples,
                this->ifft,
                this->bitRev);
          break;
