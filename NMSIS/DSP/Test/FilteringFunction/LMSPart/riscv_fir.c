...
static void riscv_fir_f32_LMS_lp(void)
{
    ...
    riscv_lms_init_f32(&S, NUM_TAPS, firCoeffs32LP, firStateF32_LMS, 0.2f, TEST_LENGTH_SAMPLES);
    ...
    riscv_lms_init_f32(&S, NUM_TAPS, firCoeffs32LP_tmp, firStateF32_LMS, 0.2f, TEST_LENGTH_SAMPLES);
...
static void riscv_fir_q31_LMS_lp(void)
{
    ...
    riscv_lms_init_q31(&S, NUM_TAPS, firCoeffs32LP_q31, firStateq31_LMS, 215, TEST_LENGTH_SAMPLES, 1);
...
static void riscv_fir_q15_LMS_lp(void)
{
    ...
    riscv_lms_init_q15(&S, NUM_TAPS, firCoeffs32LP_q15, firStateq15_LMS, 8, TEST_LENGTH_SAMPLES, 1);
