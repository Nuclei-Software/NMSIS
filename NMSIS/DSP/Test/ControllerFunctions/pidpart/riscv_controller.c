...
static int DSP_clarke_f32_app()
{
    ...
    pIbeta_ref = 0.866025;
    // ref_clarke_f32(Ia, Ib, &pIalpha_ref, &pIbeta_ref);
...
static int DSP_pid_q15_app()
{
    ...
    q15_t output_q15[100], output_q15_ref[100], ee_q15 = 0, ee_q15_ref = 0,
                                                target, ival;
    output_q15[0] = 0;
    output_q15_ref[0] = 0;
    /* Target value*/
...
static int DSP_pid_q31_app()
{
    ...
    q31_t output_q31[100], output_q31_ref[100], ee_q31 = 0, ee_q31_ref = 0,
                                                target, ival;
    output_q31[0] = 0;
    output_q31_ref[0] = 0;
    /* Target value*/
