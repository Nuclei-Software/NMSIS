...
#include "../TestData/SVMFunctions/svm_sigmoid_predict_f16/test_data.h"

#if defined (RISCV_FLOAT16_SUPPORTED)

BENCH_DECLARE_VAR();

void svm_riscv_svm_sigmoid_predict_f16(void)
{
    int32_t result;
    riscv_svm_sigmoid_instance_f16 params;
    ...
    riscv_svm_sigmoid_init_f16(&params,
        NB_SUPPORT_VECTORS,
        VECTOR_DIMENSION,
        intercept,        /* Intercept */
        dualCoefficients,
    ...
    riscv_svm_sigmoid_predict_f16(&params, f16_input, &result);
