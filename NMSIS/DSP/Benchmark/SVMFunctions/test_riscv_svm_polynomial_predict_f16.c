...
#include "TestData/SVMFunctions/svm_polynomial_predict_f16/test_data.h"

BENCH_DECLARE_VAR();

void svm_riscv_svm_polynomial_predict_f16(void)
{
#if defined (RISCV_FLOAT16_SUPPORTED)
    int32_t result;
    riscv_svm_polynomial_instance_f16 params;
    ...
    riscv_svm_polynomial_init_f16(&params,
        NB_SUPPORT_VECTORS,
        VECTOR_DIMENSION,
        intercept,
        dualCoefficients,
    ...
    riscv_svm_polynomial_predict_f16(&params, f16_input, &result);
