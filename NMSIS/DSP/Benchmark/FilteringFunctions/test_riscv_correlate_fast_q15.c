...
#include "TestData/ConvolutionFunctions/correlate_fast_q15/test_data.h"

BENCH_DECLARE_VAR();

void correlate_riscv_correlate_fast_q15(void)
{
    ...
    riscv_correlate_fast_q15(correlate_input_q15_A, ARRAYA_SIZE_Q15, correlate_input_q15_B,
                           ARRAYB_SIZE_Q15, correlate_q15_output);
