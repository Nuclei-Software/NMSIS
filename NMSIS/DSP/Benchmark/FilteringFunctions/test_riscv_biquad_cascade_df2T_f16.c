...
{
    float16_t biquad_cascade_df2T_f16_output[TEST_LENGTH_SAMPLES];
    ...
    riscv_biquad_cascade_df2T_init_f16(&S, numStages, IIRCoeffsF16LP, IIRStateF16);
    BENCH_START(riscv_biquad_cascade_df2T_f16);
    riscv_biquad_cascade_df2T_f16(&S, testInput_f16_50Hz_200Hz, biquad_cascade_df2T_f16_output, TEST_LENGTH_SAMPLES);
