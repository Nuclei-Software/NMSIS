...
#include "../TestData/FilteringFunctions/lms_norm_q31/test_data.h"

BENCH_DECLARE_VAR();

void lmsNorm_riscv_lms_norm_q31(void)
{
    q31_t error_ones_q31[TEST_LENGTH_SAMPLES];
    q31_t lms_norm_q31_output[TEST_LENGTH_SAMPLES];
    ...
    riscv_lms_norm_init_q31(&S, NUM_TAPS, firCoeffs32LP_q31, firStateQ31_LMS, MU_SIZE_Q31, TEST_LENGTH_SAMPLES, 1);
    BENCH_START(riscv_lms_norm_q31);
    riscv_lms_norm_q31(&S, testInput_q31_50Hz_200Hz, expectoutput_q31_50Hz_200Hz, lms_norm_q31_output, error_ones_q31, TEST_LENGTH_SAMPLES);
