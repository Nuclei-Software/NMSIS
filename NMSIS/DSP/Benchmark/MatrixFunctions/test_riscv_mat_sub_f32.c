...
#include "../TestData/MatrixFunctions/mat_sub_f32/test_data.h"
...
void matSub_riscv_mat_sub_f32(void)
{
    ...
    float32_t mat_sub_f32_output[M * N];

    riscv_mat_init_f32(&f32_A, M, N, mat_sub_f32_arrayA);
    riscv_mat_init_f32(&f32_B, M, N, mat_sub_f32_arrayB);
    riscv_mat_init_f32(&f32_des, M, N, mat_sub_f32_output);
