...
void kernel1x1_riscv_convolve_1x1_s4(void)
{
    ...
    generate_rand_s8(kernel1x1_int4_input, KERNEL1X1_INT4_INPUT_SIZE);
    generate_rand_s8(kernel1x1_int4_weights, KERNEL1X1_INT4_KERNEL_SIZE);
