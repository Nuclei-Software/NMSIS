...
void riscv_depthwise_conv_wrapper_s16_buffer(void)
{
    nmsis_nn_dims input_dims;
    nmsis_nn_dims filter_dims;
    nmsis_nn_dims output_dims;
    ...
    output_dims.c = input_dims.c;
    dw_conv_params.ch_mult = output_dims.c / input_dims.c;
    size = riscv_depthwise_conv_wrapper_s16_get_buffer_size(&dw_conv_params, &input_dims, &filter_dims, &output_dims);
...
void buffer_size_mve_riscv_depthwise_conv_s16(void)
{
...
void buffer_size_dsp_riscv_depthwise_conv_s16(void)
{
