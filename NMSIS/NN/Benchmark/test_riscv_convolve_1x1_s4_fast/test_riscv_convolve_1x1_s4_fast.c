...
void kernel1x1_2_riscv_convolve_1x1_s4_fast(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void kernel1x1_3_riscv_convolve_1x1_s4_fast(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void kernel1x1_stride_x_riscv_convolve_1x1_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    ...
    result = riscv_convolve_1x1_s4(&ctx,
                                 &conv_params,
                                 &quant_params,
                                 &input_dims,
                                 input_data,
...
void kernel1x1_stride_x_y_riscv_convolve_1x1_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void kernel1x1_stride_x_y_1_riscv_convolve_1x1_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    ...
    riscv_nmsis_nn_status result = riscv_convolve_1x1_s4(&ctx,
                                                     &conv_params,
                                                     &quant_params,
                                                     &input_dims,
                                                     input_data,
...
void kernel1x1_stride_x_y_2_riscv_convolve_1x1_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void buffer_size_riscv_convolve_1x1_s4_fast(void)
{
    nmsis_nn_conv_params conv_params;
    nmsis_nn_dims input_dims;
    nmsis_nn_dims filter_dims;
...
void buffer_size_mve_riscv_convolve_1x1_s4_fast(void)
{
...
void buffer_size_dsp_riscv_convolve_1x1_s4_fast(void)
{
