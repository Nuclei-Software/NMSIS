...
{
    /* Test for a complete int8 DS_CNN_S keyword spotting network from https://github.com/RISCV-software/ML-zoo &
     * Tag: 22.02 */
    nmsis_nn_context ctx;
    nmsis_nn_context ctx_kernel_sum;
    ...
    status |= riscv_fully_connected_s8(&ctx_kernel_sum,
                                     &fc_params,
