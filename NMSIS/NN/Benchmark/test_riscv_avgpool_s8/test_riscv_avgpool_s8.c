...
void avgpooling_1_riscv_avgpool_s8(void)
{
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_1_OUTPUT_W, AVGPOOLING_1_IN_CH);
    ctx.buf = malloc(ctx.size);
...
void avgpooling_2_riscv_avgpool_s8(void)
{
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_2_OUTPUT_W, AVGPOOLING_2_IN_CH);
    ctx.buf = malloc(ctx.size);
...
void avgpooling_3_riscv_avgpool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_3_OUTPUT_W, AVGPOOLING_3_IN_CH);
    ctx.buf = malloc(ctx.size);
...
void avgpooling_4_riscv_avgpool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_4_OUTPUT_W, AVGPOOLING_4_IN_CH);
    ctx.buf = malloc(ctx.size);
...
void avgpooling_5_riscv_avgpool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
    ctx.buf = malloc(ctx.size);
...
void buffer_size_mve_riscv_avgpool_s8(void)
{
#if defined(RISCV_MATH_MVEI)
    const int32_t buf_size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
    const int32_t mve_buf_size = riscv_avgpool_s8_get_buffer_size_mve(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);

    TEST_ASSERT_EQUAL(buf_size, mve_buf_size);
#endif
}

void buffer_size_dsp_riscv_avgpool_s8(void)
{
#if defined(RISCV_MATH_DSP) && !defined(RISCV_MATH_MVEI)
    const int32_t buf_size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
    const int32_t dsp_buf_size = riscv_avgpool_s8_get_buffer_size_dsp(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_IN_CH);
