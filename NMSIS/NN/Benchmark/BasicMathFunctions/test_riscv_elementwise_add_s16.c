...
void add_s16_riscv_elementwise_add_s16(void)
{
    ...
    generate_rand_s16(add_s16_input1, ADD_S16_DST_SIZE);
    generate_rand_s16(add_s16_input2, ADD_S16_DST_SIZE);

    BENCH_START(riscv_elementwise_add_s16);
    riscv_nmsis_nn_status result = riscv_elementwise_add_s16(input_data1,
                                                         input_data2,
                                                         input_1_offset,
                                                         input_1_mult,
                                                         input_1_shift,
