...
{
    /* Test for a complete int8 DS_CNN_L keyword spotting network from https://github.com/RISCV-software/ML-zoo &
     * Tag: 22.02 */
    ...
    riscv_vector_sum_s8(ctx.buf, conv_filter_dims.n, in_out_dim_1.c, ds_cnn_l_layer_14_fully_connected_weights);
#endif
