...
void dw_int16xint8_fast_spill_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_stride_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_null_bias_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_stride_null_bias_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_spill_null_bias_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_test_bias_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_multiple_batches_uneven_buffers_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void dw_int16xint8_fast_multiple_batches_uneven_buffers_null_bias_riscv_depthwise_conv_fast_s16(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void buffer_size_riscv_depthwise_conv_fast_s16(void)
{
    ...
    const int32_t buf_size = riscv_depthwise_conv_fast_s16_get_buffer_size(&input_dims, &filter_dims);
    const int32_t wrapper_buf_size =
        riscv_depthwise_conv_wrapper_s16_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, buf_size);
}

void buffer_size_mve_riscv_depthwise_conv_fast_s16(void)
{
    ...
    const int32_t mve_wrapper_buf_size =
        riscv_depthwise_conv_wrapper_s16_get_buffer_size_mve(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, mve_wrapper_buf_size);
#endif
}

void buffer_size_dsp_riscv_depthwise_conv_fast_s16(void)
{
    ...
    const int32_t dsp_wrapper_buf_size =
        riscv_depthwise_conv_wrapper_s16_get_buffer_size_dsp(&conv_params, &input_dims, &filter_dims, &output_dims);
