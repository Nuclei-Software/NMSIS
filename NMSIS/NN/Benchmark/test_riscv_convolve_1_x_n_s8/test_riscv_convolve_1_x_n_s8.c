...
void conv_1_x_n_2_riscv_convolve_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_1_x_n_3_riscv_convolve_s8(void)
{
...
void conv_1_x_n_4_riscv_convolve_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_1_x_n_5_riscv_convolve_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_1_x_n_6_riscv_convolve_s8(void)
{
    int8_t output[CONV_1_X_N_3_DST_SIZE] = {0};
    ...
    result = riscv_convolve_1_x_n_s8(&ctx,
                                   &conv_params,
                                   &quant_params,
                                   &input_dims,
                                   input_data,
