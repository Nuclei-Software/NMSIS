...
void depthwise_int4_2_riscv_depthwise_conv_s4_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void depthwise_int4_3_riscv_depthwise_conv_s4_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void depthwise_int4_4_riscv_depthwise_conv_s4_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
