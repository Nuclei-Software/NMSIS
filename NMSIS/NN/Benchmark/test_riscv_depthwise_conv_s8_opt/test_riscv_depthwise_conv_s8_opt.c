...
void depthwise_eq_in_out_ch_riscv_depthwise_conv_s8_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void depthwise_sub_block_riscv_depthwise_conv_s8_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void depthwise_out_activation_riscv_depthwise_conv_s8_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void depthwise_null_bias_0_riscv_depthwise_conv_s8_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void depthwise_x_stride_riscv_depthwise_conv_s8_opt(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void buffer_size_riscv_depthwise_conv_s8_opt(void)
{
    ...
    const int32_t buf_size = riscv_depthwise_conv_s8_opt_get_buffer_size(&input_dims, &filter_dims);
    const int32_t wrapper_buf_size =
...
void buffer_size_mve_riscv_depthwise_conv_s8_opt(void)
{
...
void buffer_size_dsp_riscv_depthwise_conv_s8_opt(void)
{
