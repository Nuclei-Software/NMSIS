...
void depthwise_kernel_3x3_riscv_depthwise_conv_3x3_s8(void)
{
    ...
    riscv_nmsis_nn_status result = riscv_depthwise_conv_3x3_s8(&ctx,
                                                           &dw_conv_params,
                                                           &quant_params,
                                                           &input_dims,
                                                           input_data,
...
void depthwise_kernel_3x3_riscv_depthwise_conv_3x3_1_s8(void)
{
    ...
    const riscv_nmsis_nn_status expected_wrapper = RISCV_NMSIS_NN_SUCCESS;
    const int32_t buf_size =
        riscv_depthwise_conv_wrapper_s8_get_buffer_size(&dw_conv_params, &input_dims, &filter_dims, &output_dims);
...
void depthwise_kernel_3x3_null_bias_riscv_depthwise_conv_3x3_null_bias_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void stride2pad1_riscv_depthwise_conv_3x3_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void buffer_size_mve_riscv_depthwise_conv_3x3_s8(void)
{
#if defined(RISCV_MATH_MVEI)
...
void buffer_size_dsp_riscv_depthwise_conv_3x3_s8(void)
{
