...
#pragma once
#define KERNEL1X1_OUT_CH 8
#define KERNEL1X1_IN_CH 512
#define KERNEL1X1_INPUT_W 8
#define KERNEL1X1_INPUT_H 8
#define KERNEL1X1_INPUT_SIZE 32768
...
#define KERNEL1X1_DST_SIZE (KERNEL1X1_INPUT_BATCHES * KERNEL1X1_OUTPUT_H * KERNEL1X1_OUTPUT_W * KERNEL1X1_OUT_CH)
