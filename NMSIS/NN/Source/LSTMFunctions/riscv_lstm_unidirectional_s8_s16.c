                                                   ...
                                                   int8_t *output_data)
{
    ...
    if (lstm->time_major)
    {
        ...
        {
            riscv_nmsis_nn_status status = riscv_nn_lstm_step_s8_s16(input_data + i_max_time * in_step,
                                                                 in_to_in_weights,
    ...
    else
    {
        for (int i_num_batch = 0; i_num_batch < num_batch; i_num_batch++)
        {
            ...
            for (int i_max_time = 0; i_max_time < max_time; i_max_time++)
            {
                ...
                riscv_nmsis_nn_status status = riscv_nn_lstm_step_s8_s16(input_data + time_offset * in_step,
                                                                     in_to_in_weights,
                                                                     in_to_forget_weights,
                                                                     in_to_cell_weights,
                                                                     in_to_out_weights,
