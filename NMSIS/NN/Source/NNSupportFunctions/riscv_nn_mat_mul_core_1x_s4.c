 ...
 * Title:        riscv_nn_mat_mul_core_1x_s4.c
                                              ...
                                              int8_t *output)
{
    ...
    for (int i = 0; i < out_ch; i++)
    {
        ...
        if (index == 3)
        {
            ...
            res = riscv_requantize_mve_32x4(res, vldrwq_s32(output_mult), vldrwq_s32(output_shift));
            output_mult += 4;
            output_shift += 4;
    ...
    for (int i = 0; i < (out_ch & 0x3); i++)
    {
        ...
        acc_n0 = riscv_nn_requantize(acc_n0, output_mult[i], output_shift[i]);
