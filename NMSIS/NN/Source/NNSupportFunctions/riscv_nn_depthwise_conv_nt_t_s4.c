 ...
 * Title:        riscv_nn_depthwise_conv_nt_t_s4.c
                                                  ...
                                                  int8_t *out)
{
         ...
         num_ch_to_process -= 4, offset += 4, out += 4, i_loop_cnt++)
    {
        ...
        out_1 = riscv_requantize_mve_32x4(out_1, mult, shift);
        ...
        out_2 = riscv_requantize_mve_32x4(out_2, mult, shift);
        ...
        out_3 = riscv_requantize_mve_32x4(out_3, mult, shift);
