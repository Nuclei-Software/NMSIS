                                            ...
                                            const int32_t lhs_cols_offset)
{
    ...
    const uint32_t ui32_lhs_offset_i16x2 = __PKHBT(i16_lhs_offset, i16_lhs_offset, 16);
    ...
    for (int32_t rhs_rows_idx = 0; rhs_rows_idx <= (rhs_rows - 4); rhs_rows_idx += 4)
    {
        ...
        while (lhs_rows_idx)
        {
            ...
            for (; rhs_cols_idx <= (rhs_cols - 16); rhs_cols_idx += 16)
            {
                ...
                lhs_low = __SXTAB16(ui32_lhs_offset_i16x2, lhs_high);
                lhs_high = __SXTAB16_RORn(ui32_lhs_offset_i16x2, lhs_high, 8);

                // 4 x MAC res00, res01
                res00 = __SMLAD(rhs_low0, lhs_low, res00);
                res00 = __SMLAD(rhs_high0, lhs_high, res00);
                res01 = __SMLAD(rhs_low1, lhs_low, res01);
                res01 = __SMLAD(rhs_high1, lhs_high, res01);

                // 4 x MAC res10, res11
                lhs_high = riscv_nn_read_s8x4((const int8_t *)&lhs_ptr[lhs_cols_off1]);
                lhs_low = __SXTAB16(ui32_lhs_offset_i16x2, lhs_high);
                lhs_high = __SXTAB16_RORn(ui32_lhs_offset_i16x2, lhs_high, 8);

                res10 = __SMLAD(rhs_low0, lhs_low, res10);
                res11 = __SMLAD(rhs_low1, lhs_low, res11);
                res10 = __SMLAD(rhs_high0, lhs_high, res10);
                res11 = __SMLAD(rhs_high1, lhs_high, res11);
