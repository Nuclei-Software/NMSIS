 ...
 * $Revision:    V.0.8.0
 *
 * Target :  RISC-V cores with DSP extension
 *
 * -------------------------------------------------------------------- */
        ...
        for (int i_out_x = 0; i_out_x < output_x; i_out_x++)
        {
            ...
            for (int i_input_ch = 0; i_input_ch < input_ch; i_input_ch++)
            {
                for (int i_ch_mult = 0; i_ch_mult < ch_mult; i_ch_mult += 2)
                {
                    ...
                    acc_0 = riscv_nn_divide_by_power_of_two(riscv_nn_sat_doubling_high_mult(
                    ...
                    /* Requantize and clamp output to provided range */
                    acc_1 = riscv_nn_divide_by_power_of_two(riscv_nn_sat_doubling_high_mult(
