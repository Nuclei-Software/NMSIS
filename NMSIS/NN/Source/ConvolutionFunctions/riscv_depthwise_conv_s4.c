 ...
 * Title:        riscv_depthwise_conv_s4.c
                ...
                for (int i_out_x = 0; i_out_x < output_x; i_out_x++)
                {
                    ...
                    if (ch_mult == 1)
                    {
                        for (int i_input_ch = 0; i_input_ch < input_ch; i_input_ch += 2, idx_out_ch_s4++)
                        {
                            ...
                            acc_0 = riscv_nn_requantize(acc_0, output_mult[i_input_ch], output_shift[i_input_ch]);
                            acc_0 += output_offset;
                            acc_0 = MAX(acc_0, output_activation_min);
                            acc_0 = MIN(acc_0, output_activation_max);
                            output[i_out++] = acc_0;

                            acc_1 = riscv_nn_requantize(acc_1, output_mult[i_input_ch + 1], output_shift[i_input_ch + 1]);
                            acc_1 += output_offset;
                    ...
                    else
                    {
                        for (int i_input_ch = 0; i_input_ch < input_ch; i_input_ch++)
                        {
                            ...
                            for (int i_ch_mult = 0; i_ch_mult < ch_mult; i_ch_mult += 2, idx_out_ch_s4++)
                            {
                                ...
                                acc_1 =
                                    riscv_nn_requantize(acc_1, output_mult[idx_out_ch + 1], output_shift[idx_out_ch + 1]);
                                acc_1 += output_offset;
                                acc_1 = MAX(acc_1, output_activation_min);
                                acc_1 = MIN(acc_1, output_activation_max);
                                output[i_out++] = acc_1;
