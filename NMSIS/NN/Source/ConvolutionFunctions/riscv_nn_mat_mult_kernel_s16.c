                                    ...
                                    int16_t *out_0)
{
    ...
    while (row_count)
    {
        ...
        else
        {
            ...
            ch_0_out_0 = riscv_nn_requantize_s64(ch_0_out_0_s64, reduced_multiplier, *out_shift);
            ch_0_out_1 = riscv_nn_requantize_s64(ch_0_out_1_s64, reduced_multiplier, *out_shift);
            out_mult++;
            out_shift++;

            reduced_multiplier = REDUCE_MULTIPLIER(*out_mult);
            ch_1_out_0 = riscv_nn_requantize_s64(ch_1_out_0_s64, reduced_multiplier, *out_shift);
            ch_1_out_1 = riscv_nn_requantize_s64(ch_1_out_1_s64, reduced_multiplier, *out_shift);
