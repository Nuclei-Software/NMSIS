 ...
 * Title:        riscv_convolve_1_x_n_s4.c
                                          ...
                                          int8_t *output_data)
{
    ...
    int32_t buffer_size = riscv_convolve_1_x_n_s4_get_buffer_size(conv_params, input_dims, filter_dims, output_dims);
    ...
    for (int i_batch = 0; i_batch < input_dims->n; i_batch++)
    {
        ...
        for (int i = 0; i < lhs_rows; i++)
        {
            ...
            status = riscv_nn_mat_mul_core_1x_s4(actual_kernel_len * input_ch,
        ...
        lhs_rows = no_pad_num;
        riscv_nn_mat_mult_nt_t_s4(input_data + input_start,
                                filter_data,
                                bias_data,
                                output_data,
        ...
        for (int i = out_idx; i < output_x; i++)
        {
            ...
            status = riscv_nn_mat_mul_core_1x_s4(ker_end_idx * input_ch,
