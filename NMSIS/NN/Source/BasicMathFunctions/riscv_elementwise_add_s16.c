                                            ...
                                            const int32_t block_size)
{
    ...
    for (; (l = __riscv_vsetvl_e16m2(blkCnt)) > 0; blkCnt -= l) {
        input_1_m4 = __riscv_vsll_vx_i32m4(__riscv_vwadd_vx_i32m4(__riscv_vle16_v_i16m2(input_1_vect, l), 0, l), left_shift, l);
        input_1_vect += l;
        input_2_m4 = __riscv_vsll_vx_i32m4(__riscv_vwadd_vx_i32m4(__riscv_vle16_v_i16m2(input_2_vect, l), 0, l), left_shift, l);
        input_2_vect += l;
        ...
        __riscv_vse16_v_i16m2(output, __riscv_vnsra_wx_i16m2(sum0m4, 0, l), l);
        output += l;
    }
