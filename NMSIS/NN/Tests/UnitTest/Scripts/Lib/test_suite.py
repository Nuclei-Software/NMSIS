...
def generate(params, args):
    ...
    # NOTE: All paths are relative to the 'NMSIS/NN/Tests/UnitTest/' folder
    fpaths = {}
    fpaths["root"] = pathlib.Path(args.root)
    fpaths["json_template_folder"] = fpaths["root"] / "Scripts" / "JsonTemplates"
