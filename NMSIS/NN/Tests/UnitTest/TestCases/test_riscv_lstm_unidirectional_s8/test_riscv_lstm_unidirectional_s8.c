...
void lstm_1(void)
{
    ...
    riscv_nmsis_nn_status result = riscv_lstm_unidirectional_s8(lstm_1_input_tensor, output, &params, &buffers);
...
void lstm_2(void)
{
    ...
    riscv_nmsis_nn_status result = riscv_lstm_unidirectional_s8(lstm_2_input_tensor, output, &params, &buffers);
...
void lstm_one_time_step(void)
{
    ...
    riscv_nmsis_nn_status result = riscv_lstm_unidirectional_s8(lstm_one_time_step_input_tensor, output, &params, &buffers);
