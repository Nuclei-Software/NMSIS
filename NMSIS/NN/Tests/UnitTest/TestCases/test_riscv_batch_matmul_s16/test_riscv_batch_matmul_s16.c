...
void batch_matmul_1_s16(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_1_S16_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_1_S16_OUTPUT_SHIFT};
    nmsis_nn_dims lhs_shape_nt = {BATCH_MATMUL_1_S16_LHS_BATCH,
    ...
    nmsis_nn_dims rhs_shape_t = {BATCH_MATMUL_1_S16_RHS_BATCH,
                                 BATCH_MATMUL_1_S16_RHS_HEIGHT,
                                 BATCH_MATMUL_1_S16_RHS_COLS,
                                 BATCH_MATMUL_1_S16_RHS_ROWS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_1_S16_OUTPUT_BATCH,
    ...
    riscv_nmsis_nn_status result = riscv_batch_matmul_s16(
...
void batch_matmul_2_s16(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_2_S16_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_2_S16_OUTPUT_SHIFT};
    nmsis_nn_dims lhs_shape_nt = {BATCH_MATMUL_2_S16_LHS_BATCH,
    ...
    nmsis_nn_dims rhs_shape_nt = {BATCH_MATMUL_2_S16_RHS_BATCH,
                                  BATCH_MATMUL_2_S16_RHS_HEIGHT,
                                  BATCH_MATMUL_2_S16_RHS_ROWS,
                                  BATCH_MATMUL_2_S16_RHS_COLS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_2_S16_OUTPUT_BATCH,
...
void batch_matmul_4_s16(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_4_S16_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_4_S16_OUTPUT_SHIFT};
    // Adj_x = 1, so we transpose lhs
    nmsis_nn_dims lhs_shape_t = {BATCH_MATMUL_4_S16_LHS_BATCH,
                                 BATCH_MATMUL_4_S16_LHS_HEIGHT,
                                 BATCH_MATMUL_4_S16_LHS_COLS,
                                 BATCH_MATMUL_4_S16_LHS_ROWS};
    // Adj_y = 1, but we do not want to transpose rhs
    nmsis_nn_dims rhs_shape_nt = {BATCH_MATMUL_4_S16_RHS_BATCH,
                                  BATCH_MATMUL_4_S16_RHS_HEIGHT,
                                  BATCH_MATMUL_4_S16_RHS_ROWS,
                                  BATCH_MATMUL_4_S16_RHS_COLS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_4_S16_OUTPUT_BATCH,
...
void batch_matmul_5_s16(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_5_S16_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_5_S16_OUTPUT_SHIFT};
    nmsis_nn_dims lhs_shape_nt = {BATCH_MATMUL_5_S16_LHS_BATCH,
                                  BATCH_MATMUL_5_S16_LHS_HEIGHT,
                                  BATCH_MATMUL_5_S16_LHS_ROWS,
                                  BATCH_MATMUL_5_S16_LHS_COLS};
    // Adj_y = 1, but we do not want to transpose rhs.
    nmsis_nn_dims rhs_shape_nt = {BATCH_MATMUL_5_S16_RHS_BATCH,
                                  BATCH_MATMUL_5_S16_RHS_HEIGHT,
                                  BATCH_MATMUL_5_S16_RHS_ROWS,
                                  BATCH_MATMUL_5_S16_RHS_COLS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_5_S16_OUTPUT_BATCH,
