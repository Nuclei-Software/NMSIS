...
void avgpooling_3_riscv_avgpool_s8(void)
{
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_3_OUTPUT_W, AVGPOOLING_3_INPUT_C);
    ctx.buf = malloc(ctx.size);
...
void avgpooling_4_riscv_avgpool_s8(void)
{
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_4_OUTPUT_W, AVGPOOLING_4_INPUT_C);
    ctx.buf = malloc(ctx.size);
...
void avgpooling_5_riscv_avgpool_s8(void)
{
    ...
    ctx.size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_INPUT_C);
    ctx.buf = malloc(ctx.size);
...
void buffer_size_dsp_riscv_avgpool_s8(void)
{
    ...
    const int32_t buf_size = riscv_avgpool_s8_get_buffer_size(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_INPUT_C);
    const int32_t dsp_buf_size = riscv_avgpool_s8_get_buffer_size_dsp(AVGPOOLING_5_OUTPUT_W, AVGPOOLING_5_INPUT_C);

    TEST_ASSERT_EQUAL(buf_size, dsp_buf_size);
#endif
}

void avgpooling_param_fail_riscv_avgpool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_ARG_ERROR;
    int8_t output[AVGPOOLING_5_OUTPUT_W * AVGPOOLING_5_OUTPUT_H * AVGPOOLING_5_BATCH_SIZE * AVGPOOLING_5_OUTPUT_C] = {
        0};
