...
void pad_int8_1_riscv_pad_s8(void)
{
    const int8_t *input_ptr = pad_int8_1_input_tensor;
    int8_t output_ptr[PAD_INT8_1_OUTPUT_SIZE] = {0};

    const nmsis_nn_dims input_size = {PAD_INT8_1_INPUT_N, PAD_INT8_1_INPUT_H, PAD_INT8_1_INPUT_W, PAD_INT8_1_INPUT_C};
    ...
    const riscv_nmsis_nn_status result =
        riscv_pad_s8(input_ptr, output_ptr, PAD_INT8_1_PAD_VALUE, &input_size, &pre_pad, &post_pad);
...
void pad_int8_2_riscv_pad_s8(void)
{
    const int8_t *input_ptr = pad_int8_2_input_tensor;
    int8_t output_ptr[PAD_INT8_2_OUTPUT_SIZE] = {0};

    const nmsis_nn_dims input_size = {PAD_INT8_2_INPUT_N, PAD_INT8_2_INPUT_H, PAD_INT8_2_INPUT_W, PAD_INT8_2_INPUT_C};
    const nmsis_nn_dims pre_pad = {
    ...
    const riscv_nmsis_nn_status result =
        riscv_pad_s8(input_ptr, output_ptr, PAD_INT8_2_PAD_VALUE, &input_size, &pre_pad, &post_pad);
    TEST_ASSERT_EQUAL(RISCV_NMSIS_NN_SUCCESS, result);
