...
void batch_matmul_1_s8(void)
{
    ...
    nmsis_nn_bmm_params bmm_params = {0, // adj_x
                                      0, // adj_y
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_1_S8_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_1_S8_OUTPUT_SHIFT};
    nmsis_nn_dims lhs_shape_nt = {BATCH_MATMUL_1_S8_LHS_BATCH,
    ...
    nmsis_nn_dims rhs_shape_t = {BATCH_MATMUL_1_S8_RHS_BATCH,
                                 BATCH_MATMUL_1_S8_RHS_HEIGHT,
                                 BATCH_MATMUL_1_S8_RHS_COLS,
                                 BATCH_MATMUL_1_S8_RHS_ROWS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_1_S8_OUTPUT_BATCH,
    ...
    int32_t buf_size = riscv_fully_connected_s8_get_buffer_size(&output_shape);
    ctx.buf = malloc(buf_size);
    ctx.size = 0;

    riscv_nmsis_nn_status result = riscv_batch_matmul_s8(
...
void batch_matmul_2_s8(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_2_S8_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_2_S8_OUTPUT_SHIFT};
    nmsis_nn_dims lhs_shape_nt = {BATCH_MATMUL_2_S8_LHS_BATCH,
    ...
    nmsis_nn_dims rhs_shape_nt = {BATCH_MATMUL_2_S8_RHS_BATCH,
                                  BATCH_MATMUL_2_S8_RHS_HEIGHT,
                                  BATCH_MATMUL_2_S8_RHS_ROWS,
                                  BATCH_MATMUL_2_S8_RHS_COLS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_2_S8_OUTPUT_BATCH,
...
{
    nmsis_nn_context ctx;
    nmsis_nn_bmm_params bmm_params = {1, // adj_x
                                      0, // adj_y
...
void batch_matmul_4_s8(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_4_S8_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_4_S8_OUTPUT_SHIFT};
    // Adj_x = 1, so we transpose lhs
    nmsis_nn_dims lhs_shape_t = {BATCH_MATMUL_4_S8_LHS_BATCH,
                                 BATCH_MATMUL_4_S8_LHS_HEIGHT,
                                 BATCH_MATMUL_4_S8_LHS_COLS,
                                 BATCH_MATMUL_4_S8_LHS_ROWS};
    // Adj_y = 1, but we do not want to transpose rhs
    nmsis_nn_dims rhs_shape_nt = {BATCH_MATMUL_4_S8_RHS_BATCH,
                                  BATCH_MATMUL_4_S8_RHS_HEIGHT,
                                  BATCH_MATMUL_4_S8_RHS_ROWS,
                                  BATCH_MATMUL_4_S8_RHS_COLS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_4_S8_OUTPUT_BATCH,
...
void batch_matmul_5_s8(void)
{
    ...
    nmsis_nn_per_tensor_quant_params quant_params = {BATCH_MATMUL_5_S8_OUTPUT_MULTIPLIER,
                                                     BATCH_MATMUL_5_S8_OUTPUT_SHIFT};
    nmsis_nn_dims lhs_shape_nt = {BATCH_MATMUL_5_S8_LHS_BATCH,
                                  BATCH_MATMUL_5_S8_LHS_HEIGHT,
                                  BATCH_MATMUL_5_S8_LHS_ROWS,
                                  BATCH_MATMUL_5_S8_LHS_COLS};
    // Adj_y = 1, but we do not want to transpose rhs.
    nmsis_nn_dims rhs_shape_nt = {BATCH_MATMUL_5_S8_RHS_BATCH,
                                  BATCH_MATMUL_5_S8_RHS_HEIGHT,
                                  BATCH_MATMUL_5_S8_RHS_ROWS,
                                  BATCH_MATMUL_5_S8_RHS_COLS};
    nmsis_nn_dims output_shape = {BATCH_MATMUL_5_S8_OUTPUT_BATCH,
