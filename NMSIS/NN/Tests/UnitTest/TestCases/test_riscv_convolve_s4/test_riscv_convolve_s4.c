...
void basic_2_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void stride2pad1_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_2_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_3_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_4_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_out_activation_riscv_convolve_s4(void)
{
    ...
    int32_t buf_size = riscv_convolve_wrapper_s4_get_buffer_size(&conv_params, &input_dims, &filter_dims, &output_dims);
    ctx.buf = malloc(buf_size);

    riscv_nmsis_nn_status result = riscv_convolve_wrapper_s4(&ctx,
                                                         &conv_params,
                                                         &quant_params,
                                                         &input_dims,
                                                         input_data,
...
void conv_2x2_dilation_riscv_convolve_s4(void)
{
...
void conv_2x2_dilation_5x5_input_riscv_convolve_s4(void)
{
...
void conv_3x3_dilation_5x5_input_riscv_convolve_s4(void)
{
...
void conv_2x3_dilation_riscv_convolve_s4(void)
{
...
void conv_3x2_dilation_riscv_convolve_s4(void)
{
...
void conv_dilation_golden_riscv_convolve_s4(void)
{
...
void conv_5_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void buffer_size_riscv_convolve_s4(void)
{
    nmsis_nn_conv_params conv_params;
    nmsis_nn_dims input_dims;
    nmsis_nn_dims filter_dims;
    ...
    const int32_t buf_size = riscv_convolve_s4_get_buffer_size(&input_dims, &filter_dims);
...
void buffer_size_dsp_riscv_convolve_s4(void)
{
    ...
    const int32_t dsp_wrapper_buf_size =
        riscv_convolve_wrapper_s4_get_buffer_size_dsp(&conv_params, &input_dims, &filter_dims, &output_dims);

    TEST_ASSERT_EQUAL(wrapper_buf_size, dsp_wrapper_buf_size);
#endif
}

void conv_1_x_n_1_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    ...
    result = riscv_convolve_1_x_n_s4(&ctx,
                                   &conv_params,
                                   &quant_params,
                                   &input_dims,
                                   input_data,
...
void conv_1_x_n_2_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_1_x_n_3_riscv_convolve_s4(void)
{
...
void conv_1_x_n_4_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void conv_1_x_n_5_riscv_convolve_s4(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
