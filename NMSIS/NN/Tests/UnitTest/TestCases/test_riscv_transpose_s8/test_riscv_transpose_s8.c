...
void transpose_default_riscv_transpose_s8(void)
{
    ...
    riscv_nmsis_nn_status result = riscv_transpose_s8(input_data, output_ptr, &input_dims, &output_dims, &transpose_params);

    TEST_ASSERT_EQUAL(expected, result);
    TEST_ASSERT_TRUE(validate(output_data, output_ref, output_ref_size));
}

void transpose_nhcw_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_NHCW_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_NHCW_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_NHCW_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_NHCW_PERM_SIZE, perm};
...
void transpose_wchn_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_WCHN_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_WCHN_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_WCHN_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_WCHN_PERM_SIZE, perm};
...
void transpose_nchw_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_NCHW_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_NCHW_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_NCHW_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_NCHW_PERM_SIZE, perm};
...
void transpose_chwn_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_CHWN_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_CHWN_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_CHWN_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_CHWN_PERM_SIZE, perm};
...
void transpose_ncwh_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_NCWH_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_NCWH_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_NCWH_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_NCWH_PERM_SIZE, perm};
...
void transpose_nwhc_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_NWHC_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_NWHC_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_NWHC_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_NWHC_PERM_SIZE, perm};
...
void transpose_3dim_riscv_transpose_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
    int8_t output_data[TRANSPOSE_3DIM_SIZE] = {0};
    int8_t *output_ptr = output_data;

    const nmsis_nn_dims input_dims = TRANSPOSE_3DIM_IN_DIM;
    const nmsis_nn_dims output_dims = TRANSPOSE_3DIM_OUT_DIM;
    ...
    const nmsis_nn_transpose_params transpose_params = {TRANSPOSE_3DIM_PERM_SIZE, perm};
