...
void lstm_1_s16(void)
{
    ...
    riscv_nmsis_nn_status result = riscv_lstm_unidirectional_s16(lstm_1_s16_input_tensor, output, &params, &buffers);
...
void lstm_2_s16(void)
{
    ...
    // INPUT GATE
    const nmsis_nn_lstm_gate gate_input = {LSTM_2_S16_INPUT_GATE_INPUT_MULTIPLIER,
    ...
    // FORGET GATE
    const nmsis_nn_lstm_gate gate_forget = {LSTM_2_S16_FORGET_GATE_INPUT_MULTIPLIER,
    ...
    // CELL GATE
    const nmsis_nn_lstm_gate gate_cell = {LSTM_2_S16_CELL_GATE_INPUT_MULTIPLIER,
    ...
    // OUTPUT GATE
    const nmsis_nn_lstm_gate gate_output = {LSTM_2_S16_OUTPUT_GATE_INPUT_MULTIPLIER,
    ...
    // LSTM DATA
    const nmsis_nn_lstm_params params = {LSTM_2_S16_TIME_MAJOR,
    ...
    riscv_nmsis_nn_status result = riscv_lstm_unidirectional_s16(lstm_2_s16_input_tensor, output, &params, &buffers);
...
void lstm_one_time_step_s16(void)
{
    ...
    // INPUT GATE
    const nmsis_nn_lstm_gate gate_input = {LSTM_ONE_TIME_STEP_S16_INPUT_GATE_INPUT_MULTIPLIER,
    ...
    // FORGET GATE
    const nmsis_nn_lstm_gate gate_forget = {LSTM_ONE_TIME_STEP_S16_FORGET_GATE_INPUT_MULTIPLIER,
    ...
    // CELL GATE
    const nmsis_nn_lstm_gate gate_cell = {LSTM_ONE_TIME_STEP_S16_CELL_GATE_INPUT_MULTIPLIER,
    ...
    // OUTPUT GATE
    const nmsis_nn_lstm_gate gate_output = {LSTM_ONE_TIME_STEP_S16_OUTPUT_GATE_INPUT_MULTIPLIER,
    ...
    // LSTM DATA
    const nmsis_nn_lstm_params params = {LSTM_ONE_TIME_STEP_S16_TIME_MAJOR,
