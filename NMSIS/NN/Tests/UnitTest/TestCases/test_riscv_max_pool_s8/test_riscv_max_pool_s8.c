...
void maxpooling_riscv_max_pool_s8(void)
{
    ...
    for (int i = 0; i < REPEAT_NUM; i++)
    {
        riscv_nmsis_nn_status result =
            riscv_max_pool_s8(&ctx, &pool_params, &input_dims, input_data, &filter_dims, &output_dims, output);
...
void maxpooling_1_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_2_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_3_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_4_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_5_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_6_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_7_riscv_max_pool_s8(void)
{
    const riscv_nmsis_nn_status expected = RISCV_NMSIS_NN_SUCCESS;
...
void maxpooling_param_fail_riscv_max_pool_s8(void)
{
