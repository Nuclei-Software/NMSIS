...
riscv_nmsis_nn_status riscv_convolve_1_x_n_s4_ref(const nmsis_nn_context *ctx,
                                          ...
                                          int8_t *output_data)
{
    ...
    int32_t buffer_size = riscv_convolve_s4_get_buffer_size_ref(input_dims, filter_dims);
    ...
    status = riscv_convolve_s4_ref(ctx,
                             conv_params,
                             quant_params,
                             input_dims,
                             input_data,
