 ...
 * Title:        riscv_depthwise_conv_wrapper_s4_ref.c
 ...
 *
 */
riscv_nmsis_nn_status riscv_depthwise_conv_wrapper_s4_ref(const nmsis_nn_context *ctx,
                                                  ...
                                                  int8_t *output)
{
    ...
    {
        status = riscv_depthwise_conv_s4_opt_ref(ctx,
                                           dw_conv_params,
                                           quant_params,
                                           input_dims,
                                           input,
    ...
    {
        status = riscv_depthwise_conv_s4_ref(ctx,
                                       dw_conv_params,
                                       quant_params,
                                       input_dims,
                                       input,
