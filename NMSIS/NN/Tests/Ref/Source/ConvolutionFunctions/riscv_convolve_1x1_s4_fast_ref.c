 ...
 * Title:        riscv_convolve_1x1_s4_fast_ref.c
...
riscv_nmsis_nn_status riscv_convolve_1x1_s4_fast_ref(const nmsis_nn_context *ctx,
                                             ...
                                             int8_t *output_data)
{
    ...
    riscv_nn_mat_mult_nt_t_s4_ref(input_data,
                            filter_data,
                            bias_data,
                            output_data,
