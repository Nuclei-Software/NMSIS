 ...
 * Title:        riscv_depthwise_conv_s4_ref.c
...
static void depthwise_conv_s4_generic_ref(const int8_t *input,
 ...
 *
 */
riscv_nmsis_nn_status riscv_depthwise_conv_s4_ref(const nmsis_nn_context *ctx,
                                          ...
                                          int8_t *output)
{
    ...
    depthwise_conv_s4_generic_ref(input,
                              input_dims->n,
                              input_dims->w,
                              input_dims->h,
                              input_dims->c,
