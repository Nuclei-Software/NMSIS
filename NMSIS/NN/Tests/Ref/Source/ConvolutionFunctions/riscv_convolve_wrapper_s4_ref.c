 ...
 * Title:        riscv_convolve_wrapper_s4_ref.c
...
riscv_nmsis_nn_status riscv_convolve_wrapper_s4_ref(const nmsis_nn_context *ctx,
                                            ...
                                            int8_t *output_data)
{
        ...
        (filter_dims->h == 1) && (conv_params->dilation.w == 1 && conv_params->dilation.h == 1))
    {
        ...
        {
            return riscv_convolve_1x1_s4_fast_ref(ctx,
                                            conv_params,
                                            quant_params,
                                            input_dims,
                                            input_data,
        ...
        {
            return riscv_convolve_1x1_s4_ref(ctx,
                                       conv_params,
                                       quant_params,
                                       input_dims,
                                       input_data,
    ...
    {
        return riscv_convolve_s4_ref(ctx,
                               conv_params,
                               quant_params,
                               input_dims,
                               input_data,
