                                       ...
                                       int16_t *gate)
{
    ...
    riscv_nn_vec_mat_mul_result_acc_s8_ref(input,
    ...
    riscv_nn_vec_mat_mul_result_acc_s8_ref(output_state,
    ...
    riscv_nn_activation_s16_ref(gate, gate, n_block, 0, activation_type);
}
/**
