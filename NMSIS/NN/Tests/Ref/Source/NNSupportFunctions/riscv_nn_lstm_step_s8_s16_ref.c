 ...
 * Title:        riscv_nn_lstm_step_s8_s16.c
 ...
 */
riscv_nmsis_nn_status riscv_nn_lstm_step_s8_s16_ref(const int8_t *input,
                                            ...
                                            nmsis_nn_lstm_context *scratch_buffers)
{
    ...
    riscv_nn_lstm_calculate_gate_s8_s16_ref(input,
    ...
    riscv_nn_lstm_update_cell_state_s16_ref(n_block,
    ...
    riscv_nn_lstm_update_output_s8_s16_ref(n_batch,
                                     n_cell,
                                     cell_state,
                                     lstm->cell_state_shift,
                                     scratch_buffers->output_gate,
    ...
    riscv_memcpy_s8(output, output_state, n_batch * n_output * sizeof(int8_t));
