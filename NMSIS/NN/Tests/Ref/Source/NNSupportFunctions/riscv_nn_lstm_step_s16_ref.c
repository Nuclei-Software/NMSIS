 ...
 */
riscv_nmsis_nn_status riscv_nn_lstm_step_s16_ref(const int16_t *data_in,
                                         ...
                                         const int32_t batch_offset)
{
    ...
    riscv_nn_lstm_calculate_gate_s16_ref(data_in, hidden_in, &params->forget_gate, params, forget_gate, batch_offset);
    ...
    riscv_nn_lstm_calculate_gate_s16_ref(data_in, hidden_in, &params->input_gate, params, input_gate, batch_offset);

    riscv_nn_lstm_calculate_gate_s16_ref(data_in, hidden_in, &params->cell_gate, params, cell_gate, batch_offset);
    ...
    riscv_nn_lstm_calculate_gate_s16_ref(data_in, hidden_in, &params->output_gate, params, output_gate, batch_offset);
    ...
    riscv_elementwise_mul_s16_batch_offset_ref(output_gate,
                                         hidden_temp,
                                         hidden_out,
