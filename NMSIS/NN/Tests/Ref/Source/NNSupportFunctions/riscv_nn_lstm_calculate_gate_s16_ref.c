 ...
 * Title:        riscv_nn_lstm_calculate_gate_s16.c
 ...
 */
riscv_nmsis_nn_status riscv_nn_lstm_calculate_gate_s16_ref(const int16_t *data_in,
                                                   ...
                                                   const int32_t batch_offset)
{
    ...
    riscv_nn_vec_mat_mul_result_acc_s16_ref(data_in,
                                      gate->input_weights,
    ...
    if (hidden_in)
    {
        ...
        riscv_nn_vec_mat_mul_result_acc_s16_ref(hidden_in,
                                          gate->hidden_weights,
    ...
    riscv_nn_activation_s16_ref(output, output, params->hidden_size * params->batch_size, 0, gate->activation_type);
